...
import RoadmapThreeVue from '@/views/Roadmap/RoadmapThree.vue'
...
const defaultRoutes=[
    ...
    {path:'/',component:LayoutVue,redirect:'/introduction',children:[
        // Introduction
...
// 需要权限的路由
const addRoutes=[{path:'/',component:LayoutVue,redirect:'/introduction',meta:{role:['teacher','student']},children:[
    {path:'/task',component:TaskVue,meta:{role:['teacher']}}]
}]
// 创建路由器
...
// 导出路由
export default {defaultRoutes,addRoutes}
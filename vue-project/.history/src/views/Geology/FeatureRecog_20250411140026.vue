              ...
              <div class="hydrodynamic-section">
                ...
                >
                  ...
                  >
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/湖泊中的潮汐作用.jpg" class="geo-image" alt="湖泊中的潮汐作用" />
                        <div class="geo-image-caption theme-marine">湖泊中的潮汐作用</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/浪蚀湖岸.jpg" class="geo-image" alt="浪蚀湖岸" />
                        <div class="geo-image-caption theme-marine">浪蚀湖岸</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/湖滩.jpg" class="geo-image" alt="湖滩" />
              ...
              <div class="subfacies-section">
                ...
                >
                  ...
                  <div v-show="lakeSubfacies.deep" class="subfacies-detail">
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/页岩.jpg" class="geo-image" alt="页岩" />
                        <div class="geo-image-caption theme-marine">页岩</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/San Nicandro Fm厚粉质矿床剖面（深湖相）.jpg" class="geo-image" alt="San Nicandro Fm厚粉质矿床剖面（深湖相）" />
                        <div class="geo-image-caption theme-marine">San Nicandro Fm厚粉质矿床剖面（深湖相）</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div v-show="lakeSubfacies.shallow" class="subfacies-detail">
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/鲕粒灰岩.jpg" class="geo-image" alt="鲕粒灰岩" />
                        <div class="geo-image-caption theme-marine">鲕粒灰岩</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/湖相交错层理.jpg" class="geo-image" alt="湖相交错层理" />
                        <div class="geo-image-caption theme-marine">湖相交错层理</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div v-show="lakeSubfacies.expanded" class="subfacies-detail">
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/湖相泥岩与灰岩.jpg" class="geo-image" alt="湖相泥岩与灰岩" />
                        <div class="geo-image-caption theme-marine">湖相泥岩与灰岩</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/坳陷盆地湖泊.jpg" class="geo-image" alt="坳陷盆地湖泊" />
                        <div class="geo-image-caption theme-marine">坳陷盆地湖泊</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="rock-characteristics">
                ...
                >
                  ...
                  >
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/介形虫.jpg" class="geo-image" alt="介形虫" />
                        <div class="geo-image-caption theme-marine">介形虫</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/轮藻.jpg" class="geo-image" alt="轮藻" />
                        <div class="geo-image-caption theme-marine">轮藻</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img src="@/assets/FeatureRecog/09湖泊相/湖底含化石钙质页岩.jpg" class="geo-image" alt="湖底含化石钙质页岩" />
                        <div class="geo-image-caption theme-marine">湖底含化石钙质页岩</div>
                      </div>
                    </div>
                  </div>
                </div>

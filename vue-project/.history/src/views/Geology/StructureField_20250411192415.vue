        ...
        <section class="section">
          ...
          <div v-if="expandedSections.extensionTypes" class="section-content">
            ...
            <div class="definition-card" style="border-left-color: #8e44ad">
              ...
              <p>
                地堑常成长条形的断陷盆地，东非大裂谷、我国东部新生代盆地都是典型地堑构造系。
              </p>
              <p>
...
.section-content {
  ...
  background-color: #fffefb;
  background-image: 
    linear-gradient(to bottom, transparent 95%, rgba(141, 110, 99, 0.03) 100%),
    radial-gradient(circle at 10% 20%, rgba(141,110,99,0.02) 0%, transparent 20%);
}

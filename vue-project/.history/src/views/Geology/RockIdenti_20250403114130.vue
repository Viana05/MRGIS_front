            ...
            >
              <div class="igneous-content">
                ...
                <div class="rock-identification-container">
                  <h2 class="rock-class-title">橄榄岩-苦橄岩类</h2>

                  <div class="rock-card-container">
                    <!-- 纯橄榄岩 -->
                    <div class="rock-card">
                      ...
                      <div class="rock-content">
                        <div class="rock-image-group">
                          <div class="image-box">
                            <img
                              src="@/assets/RockIdenti/纯橄榄岩.jpg"
                              alt="纯橄榄岩手标本"
                            />
                            <p class="image-caption">手标本</p>
                          </div>
                        </div>
                        <div class="rock-description">
                          <div class="specimen-feature">
                            <h4>手标本特征</h4>
                            <p>
                              几乎全由橄榄石组成。橄榄石为浅绿色，粒状，玻璃光泽，没有解理。
                            </p>
                          </div>
                          <div class="microscopic-feature">
                            <h4>镜下特征</h4>
                            <p>橄榄石呈自形粒状或他形粒状。</p>
                          </div>
                        </div>

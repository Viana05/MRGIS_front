        ...
        <section class="section">
          ...
          <div v-if="expandedSections.strikeSlipFault" class="section-content">
            ...
            <div class="geo-image-group">
              <div class="geo-image-container">
                <img src="@/assets/StructureField/01断层/右行走滑断层和左行走滑断层.jpg" alt="右行走滑断层和左行走滑断层" class="geo-image  geo-image-small" />
                <div class="geo-image-caption">右行走滑断层和左行走滑断层</div>
              </div>
              <div class="geo-image-container">
                <img src="@/assets/StructureField/01断层/左阶式与右阶式滑断层.jpg" alt="左阶式与右阶式滑断层" class="geo-image" />

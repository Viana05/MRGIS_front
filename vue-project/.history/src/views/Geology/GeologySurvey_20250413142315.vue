                    ...
                    >
                      <div class="image-container" :style="containerStyle">
                        <img
                          ...
                          class="slide-image"
                          :style="{
                            'object-position': slide.focusPoint || 'center',
                          }"
                        />
                      </div>
          ...
          <div v-if="activeSection === 'usage-details'" class="usage-section">
            <div class="geology-card">
              ...
              <div class="method-item">
                ...
                <div class="geo-image-container center-image">
                  <img
                    src="@/assets/GeologySurvey/01罗盘的使用/岩层产状.jpg"
                    alt="岩层产状"
                    class="geo-image"
                  />
                  <p class="image-caption">岩层产状</p>
                </div>
                <div class="method-content">
      ...
      <div v-if="activeTab === 'record'" class="content-section">
        <div class="geology-card">
          ...
          <div class="field-content">
            <div class="geo-image-container center-image">
              <img
                src="@/assets/GeologySurvey/02野簿定点记录和信手剖面图/实例.jpg"
                alt="实例"
                class="geo-image"
              />
              <p class="image-caption">实例</p>
            </div>
            <div class="geo-image-container center-image">
              <img
                src="@/assets/GeologySurvey/02野簿定点记录和信手剖面图/野簿记录示范1.jpg"
                alt="野簿记录示范1"
                class="geo-image"
              />
              <p class="image-caption">野簿记录示范1</p>
            </div>
            <div class="geo-image-container center-image">
              <img
                src="@/assets/GeologySurvey/02野簿定点记录和信手剖面图/野簿记录示范2.jpg"
                alt="野簿记录示范2"
                class="geo-image"
              />
              <p class="image-caption">野簿记录示范2</p>
            </div>
          </div>
        </div>
      </div>

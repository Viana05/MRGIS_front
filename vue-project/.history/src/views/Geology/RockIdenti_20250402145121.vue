            ...
            >
              <div class="rock-content">
                ...
                <div class="rock-comparison-container">
                  ...
                  <div class="comparison-image-wrapper">
                    <img
                      ...
                      alt="辉长岩"
                    />
                    <span class="comparison-caption">辉长岩</span>
                  </div>
                  <!-- 伟晶岩 -->
                  <div class="comparison-image-wrapper">
                    <img
                      ...
                      alt="伟晶岩"
                    />
                    <span class="comparison-caption">伟晶岩</span>
                  </div>
                  <!-- 辉长岩 -->
                  <div class="comparison-image-wrapper">
                    <img
                      ...
                      alt="闪长岩"
                    />
                    <span class="comparison-caption">闪长岩</span>
                  </div>
                </div>
                <p>
                ...
                <p class="highlight-danger">
                  <strong>玄武岩</strong>是一种细粒致密、外观呈黑色的火成岩，由基性岩浆喷发凝结而成，主要成分是硅铝酸钠或硅铝酸钙。玄武岩岩浆的黏度小，易于流动，常形成广大的熔岩台地，所以分布很广。
                </p>
                <p class="highlight-danger">
                  <strong>安山岩</strong>为中性喷出岩，分布范围仅次于玄武岩。岩石一般为灰、灰绿、淡紫或紫红色，其中含有少量斜长石、角闪石、辉石和黑云母的斑晶，且斑晶常呈定向排列，这是由于岩浆是在流动中冷却的。
                </p>
                <p class="highlight-danger">
                  <strong>黑曜岩（黑曜石）</strong>是一种致密块状或熔渣状的酸性玻璃质火山岩，和松脂岩、珍珠岩都统称为酸性火山玻璃岩。呈致密块状，有时见石泡构造。
                </p>
                <p class="highlight-danger">
                  <strong>流纹岩</strong>的化学成分与花岗岩相同，是一种火山喷出岩。大多数流纹岩都具斑状结构，表明结晶作用在喷发作用以前就已开始。
                </p>
                <div class="rock-comparison-container">
                  <!-- 玄武岩 -->
                  <div class="comparison-image-wrapper">
                    <img
                      ...
                      alt="玄武岩"
                    />
                    <span class="comparison-caption">玄武岩</span>
                  </div>
                  <!-- 安山岩 -->
                  <div class="comparison-image-wrapper">
                    <img
                      ...
                      alt="安山岩"
                    />
                    <span class="comparison-caption">安山岩</span>
                  </div>
                  <!-- 黑曜岩 -->
                  <div class="comparison-image-wrapper">
                    <img
                      ...
                      alt="黑曜岩"
                    />
                    <span class="comparison-caption">黑曜岩</span>
                  </div>
                  <!-- 流纹岩 -->
                  <div class="comparison-image-wrapper">
                    <img
                      ...
                      alt="流纹岩"
                    />
                    <span class="comparison-caption">流纹岩</span>
                  </div>
                </div>
              </div>
            </el-collapse-item>

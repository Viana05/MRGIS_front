          ...
          >
            ...
            <div class="structure-type">
              ...
              <div v-show="!collapsed.birdseye">
                <div class="geo-image-group uniform-height">
                  <div class="geo-image-wrapper">
                    <img src="@/assets/FeatureRecog/05沉积构造/鸟眼构造1.jpg" class="geo-image" alt="鸟眼构造1" />
                    <div class="geo-image-caption theme-lake">鸟眼构造1</div>
                  </div>
                  <div class="geo-image-wrapper">
                    <img src="@/assets/FeatureRecog/05沉积构造/鸟眼构造2.jpg" class="geo-image" alt="鸟眼构造2" />
                    <div class="geo-image-caption theme-lake">鸟眼构造2</div>
                  </div>
                </div>
                <p>

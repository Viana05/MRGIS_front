    ...
    <div v-if="activeTab === 'extension'" class="extension-content">
      <section class="section">
        <div class="section-header" @click="toggleSection('extensionTypes')">
          <h2>伸展构造型式</h2>
          <span class="toggle-icon">{{ expandedSections.extensionTypes ? '−' : '+' }}</span>
        </div>
        <div v-if="expandedSections.extensionTypes" class="section-content">
          <p class="geo-text">伸展构造作为全球构造中最为醒目的构造类型之一，是在岩石圈拉伸及薄化作用下形成的特殊构造组合系统。</p>
          <p class="geo-text">重力及重力不稳定性是形成伸展构造的驱动机制之一，伸展作用可导致形成不同规模和样式的重力滑动及伸展坍陷构造。</p>
          
          <div class="definition-card" style="border-left-color: #8e44ad;">
            <h3>伸展构造型式</h3>
            <p>在大陆伸展地区，伸展构造主要表现为正向滑动为主的断层、剪切带和拆离带组合型式，发育在不同的层次、尺度、区域构造背景和构造演化阶段。包括了以下几个构造型式：地堑和地垒、断陷盆地、裂谷、变质核杂岩、岩墙群。</p>
            <p>地堑（graben）是地壳上广泛发育的一种地质构造，为两侧被高角度断层围限，中间下降的槽形断块构造。</p>
            <p>仅在一侧为断层所限的断陷，称为半地堑或箕状构造。大规模地堑发育的地方，预示着地壳拉伸变薄 。</p>
            <p>地堑常成长条形的断陷盆地，东非大裂谷、我国东部新生代盆地都是典型的地堑构造系。</p>
            <p>地垒（horst）与地堑恰好相反，由两组走向平行反向倾斜的正断层构成。在简单情况下，由两条正断层组成的地垒，中间共同的下盘上升，两侧的断层上盘下降。</p>
            <p>通常情况下，地堑和地垒相伴发育，正断层多呈阶梯状，形成盆岭构造（以美国盆岭区为原型命名的大型伸展构造）。</p>
            <p>盆岭构造是指在伸展变形区域，由掀斜构造、阶梯状正断层、地堑、地垒等共同产出，形成由不对称的纵列单面山、山岭及其间的盆地组合而成的构造一地貌单元。</p>
            <p>在伸展背景条件下受基底及盆缘正断层控制发育的沉积盆地，称为断陷盆地。如我国东部的华北盆地、松辽盆地和江汉盆地等。</p>
            <p>如果断陷盆地一侧断层发育，形成一侧由主干弧形或铲形正断层控制的不对称盆地，则称为箕状断陷或半地堑盆地。一般情况下，断陷盆地规模越大，盆缘及盆内构造越复杂。</p>
            <p>裂谷是区域性伸展隆起背景上形成的巨大窄长断陷，切割深，发育演化期长，常具有地堑型式。按照裂谷发育的区域构造部位及其地质构造特征，可分为以下三类：大洋裂谷、大陆裂谷、陆间裂谷。</p>
            <p>大西洋中央海岭上的裂谷是大洋裂谷的典型，东非裂谷是大陆裂谷的典型，红海裂谷是陆间裂谷的典型。</p>
            <p>裂谷在板块构造学中是大陆崩裂、大洋开启的初始阶段，是洋盆的雏形，但并非都会演化发展成为大洋。当裂谷中止伸展开裂，停止发育，裂谷坳陷就可能被各类岩石所充填而失去构造形态特征。</p>
            <p>变质核杂岩是由从深部抽拉抬升的强烈变质变形基底(下盘)和变质变形较弱的盖层（上盘）组成，外形近圆形或椭圆形，半径可达般万余米，呈分散孤立的穹隆状产出。</p>
            <p>基底与盖层以规模巨大的低角度正断拆离断层分隔。拆离断层原始产状近水平，在伸展拆离中变成犁式。其上盘以发育多米诺式断层为特征，亦有次级顺层断层，并使地层拆离减薄和缺失。</p>
            <p>岩墙是横切围岩构造的板状侵入岩体，常成群出现，呈平行或放射状排列，是一种伸展构造的重要样式。</p>
            <p>在全球各大克拉通内广泛发育前寒武纪岩墙群，主要以晚前寒武纪基性岩墙群为主。与超大陆裂解事件相关的基性岩墙群一般宽数十米至数百米，长数十公里至数百公里，甚至上千公里。</p>
          </div>
        </div>
      </section>

      <section class="section">
        <div class="section-header" @click="toggleSection('extensionDevelopment')">
          <h2>发育规律及动力学过程</h2>
          <span class="toggle-icon">{{ expandedSections.extensionDevelopment ? '−' : '+' }}</span>
        </div>
        <div v-if="expandedSections.extensionDevelopment" class="section-content">
          <p class="geo-text">一些几何学的、运动学的及动力学的模式可以来解释不同构造层次上伸展构造的发育规律及动力学过程。</p>
          
          <div class="definition-card" style="border-left-color: #9b59b6;">
            <h3>发育规律</h3>
            <p>B. Wernicke和B. C. Burchfiel等人根据断层面几何形态及断块沿断层面位移特点，将正断层划分为两种类型，即非旋转(高角度)的和旋转的。</p>
            <p>其中旋转一类中又分出仅岩层旋转的铲状断层及断层和岩层均旋转的平面断层或铲状断层，并分别讨论了计算它们伸展量的方法。</p>
            <p>B. Wernicke等的正断层分类适合于地壳浅层次及伸展盆地内断层的观察和解释。当然，它们的组合型式也可能反映了深部更大规模的伸展构造。</p>
            <p>利斯特等(G. S. Lister, 1986)依据形成断层组合应力状态，总结了大陆伸展构造的如下三种模式，而不同模式形成的伸展构造型式也有明显差异。三种模式分别为：纯剪模式、单剪模式、分层剪切或滑动剪切。</p>
            <p>不同构造层次的伸展构造所表现的几何型式和和应力状态是不一致的，除此之外，不同构造层次的物质组成、相转换、流变状态及物理化学环境也不相同，因此在分析伸展构造建立模型，应当从组成及变形两个方面全面考虑。</p>
            <p>马杏垣(1982)参考G. P. Eaton对北美大盆地地壳剖面解释，提出一个伸展大陆壳结构模型，具有代表性。</p>
            <p>从图中可以看出，地壳浅层次以各种正断层及低缓角度拆离带组合为主，中层次以塑性变形为主，表现为塑性伸展流动，出现糜棱岩带和网结状韧性剪切带，地壳深部除塑性伸展流动变形外，尚发育大量基性岩墙(床)群。</p>
            <p>Vink等人早已指出，大陆壳发育裂谷作用要比在洋壳上容易得多，这是因为大陆岩石圈比大洋岩石圈强度小。大量的实践证明，大陆裂谷一般产生在古老的逆冲构造带，变质核杂岩大多发育于造山带，是造山期后伸展作用的结果。</p>
            <p>G. Ranalli认为，增厚的岩石圈拆沉作用是造山带构造演化的一个重要动力学过程，可以导致由挤压体制向伸展体制的反转。</p>
            <p>拆沉作用的基本涵义是：大陆岩石圈地幔由于较软流圈温度低、密度较大，从而产生重力不稳，如有合适的断裂，岩石圈地慢将沉陷入软流圈中，并使岩石圈减薄。</p>
            <p>理论计算证明，岩石圈根带的拆沉作用(delamination)，可产生水平方向的差异张应力50~100MPa，足以驱动大规模伸展构造的发育。</p>
          </div>
        </div>
      </section>

      <section class="section">
        <div class="section-header" @click="toggleSection('extensionReversal')">
          <h2>构造反转</h2>
          <span class="toggle-icon">{{ expandedSections.extensionReversal ? '−' : '+' }}</span>
        </div>
        <div v-if="expandedSections.extensionReversal" class="section-content">
          <div class="definition-card" style="border-left-color: #3498db;">
            <h3>构造反转</h3>
            <p>近年来，构造反转受到地质学家广泛关注。</p>
            <p>狭义上的构造反转多限于盆地内部，是指早期一个张性或张扭性盆地后期转变为压性或压扭性构造盆地(正反转构造)，盆地由伸展沉降转为挤压上隆，正断层转变为逆断层。</p>
            <p>或盆地内先存的挤压系统部分转变为伸展系统(负反转构造)。这种构造反转虽然构造体制上发生重大转化，但变形不一定强烈，因此在不同层次上某些构造仍保持反转前的部分特征。</p>
            <p>挤压作用与伸展作用是紧密相关的，在区域尺度上，伸展构造最发育的部位，可能也是先期挤压缩短作用最为强烈、地壳甚至岩石圈厚度最大的地区。</p>
            <p>伸展构造与整个岩石圈（lithosphere）的组成、结构、强度和热状态等相关。因此在研究伸展构造变形时，应从不同构造层次的物理状况及岩石圈流变学观点进行分析应。伸展和挤压两种作用及其形成的两类构造各具特色。它们在一定区域构造演化中相互交替和重叠，往往引起构造的叠加和穿插。</p>
          </div>
        </div>
      </section>
    </div>
    ...
    <div v-if="activeTab === 'shear'" class="shear-content">
      <section class="section">
        <div class="section-header" @click="toggleSection('shearTypes')">
          <h2>剪切带类型</h2>
          <span class="toggle-icon">{{ expandedSections.shearTypes ? '−' : '+' }}</span>
        </div>
        <div v-if="expandedSections.shearTypes" class="section-content">
          <p class="geo-text">剪切带是地壳和岩石圈中广泛发育的主要构造类型之一，可以在不同层次、不同环境下发育。</p>
          <p class="geo-text">其尺度范围包括从超显微的晶格位错到造山带或变质基底内几十公里宽和上千公里长的韧性剪切带。</p>
          <p class="geo-text">对于剪切带的研究在整个岩石圈构造及全球构造动力学方面具有重要意义。</p>
          
          <div class="definition-card" style="border-left-color: #e74c3c;">
            <h3>剪切带类型</h3>
            <p>根据剪切带的几何产状和运动方式，可将剪切带划分为走滑(平移)型剪切带、推覆(逆冲)型剪切带和滑覆(正断)型剪切带等主要类型。根据剪切带发育的物理环境和变形机制的不同,可将剪切带划分为下列三种基本类型：脆性剪切带、脆—韧（韧—脆）性剪切带、韧性剪切带。</p>
            <p>脆性剪切带是在地壳上部的低温及高孔隙压力与静岩压力比条件下发生的脆性变形的产物。</p>
            <p>其特点是具有一个或多个清楚的不连续界面，两盘位移明显，变形集中在个别不连续面上，伴生有各种碎裂岩系列的断层岩。</p>
            <p>脆-韧性剪切带有多种类型，主要型式有两种：一种为似断层牵引现象的脆-韧性剪切带。</p>
            <p>在韧性变形的岩石内部发育不连续面，沿不连续面可能产生摩擦滑动，其两侧一定范围内的岩层或其他标志体则发生一定程度的塑性变形；</p>
            <p>另一种为韧-脆性剪切带由张裂脉的雁行状阵列表现出来，雁列张裂隙反映岩石的跪性变形，而张裂隙之间的岩石一般受到一定程度的塑性变形。</p>
            <p>韧性剪切带是岩石在塑性状态下发生连续变形的狭窄高剪切应变带。典型韧性剪切带内变形状态从一壁穿过剪切带到另一壁是连续的，无破裂或不连续面。</p>
            <p>带内变形和两盘的位移完全由岩石的塑性流动或晶内变形来完成，并遵循不同的塑性或粘性蠕变律。</p>
            <p>根据剪切带的边界条件和位移情况，韧性剪切带的几何类型可分为如下两种：剪切带外的岩石未受变形的韧性剪切带、剪切带外的岩石受到均匀应变的韧性剪切带。</p>
            <p>剪切带外的岩石未受变形的韧性剪切带包括：不均匀的简单剪切（A）；不均匀的体积变化（B）；不均匀的简单剪切和不均匀的体积变化之联合（C）。</p>
            <p>剪切带外的岩石受到均匀应变的韧性剪切带包括：均匀应变与不均匀的简单剪切之联合（D）；均匀应变与不均匀的体积变化之联合（E）；均匀应变、不均匀的简单剪切和不均匀的体积变化之联合（F）。</p>
          </div>
        </div>
      </section>
      ...
      <section class="section">
        <div class="section-header" @click="toggleSection('ductileShear')">
          <h2>韧性剪切带</h2>
          <span class="toggle-icon">{{ expandedSections.ductileShear ? '−' : '+' }}</span>
        </div>
        <div v-if="expandedSections.ductileShear" class="section-content">
          <div class="definition-card" style="border-left-color: #3498db;">
            <h3>韧性剪切带</h3>
            <p>从力学角度来看，韧性剪切带是地壳和岩石圈中不同尺度的缺陷，是应变软化带和应变局部化带。</p>
            <p>其变形过程中的应力、应变速率和温度等环境条件之间的关系，受不同的流动律控制，从而形成了特征性的岩石、构造和其他微观变形现象。</p>
            <p>糜棱岩是颗粒很细呈条带状分布的动力变质岩。岩石中大部分矿物不能用肉眼分辨。</p>
            <p>由原来粗粒岩石(花岗岩等)受强烈的定向压力破碎成粉末状(断层泥)，再经胶结形成坚硬岩石，矿物成分与原岩无多大变化。</p>
            <p>糜棱岩中不同矿物常常具有不同的形态和变形特征。石英相对容易发生塑性变形，常呈矩形，或为细小的重结晶颗粒围绕碎斑，构成糜棱岩的典型构造－核幔构造。</p>
            <p>长石等硬矿物一般颗粒较大，多以残斑出现，常表现为脆性碎裂，也可因位错滑移形成波状消光及机械双晶等现象。</p>
            <p>在各向异性的地质体内产出的韧性剪切带内,经常出现复杂的褶皱变形。</p>
            <p>由于剪切带内差异性剪切作用,改变了先存面状构造的方位,导致标志层出现被动褶皱，一般形成相似褶皱。</p>
            <p>主动纵弯褶皱是先存标志体或面状构造受挤压失稳形成的。褶皱形成的先决条件是：标志体与围岩之间存在能于性差。</p>
            <p>鞘褶皱是韧性剪切带中一种特殊的A型褶皱（剪切带中大部分褶皱的褶轴与拉伸线理的方向大致平行）。</p>
            <p>因形似刀鞘故名鞘褶皱。鞘褶皱常成群出现。大小不一，以中、小型为主。鞘褶皱大多呈扁圆状或舌状，或成圆筒状。多数为不对称褶皱</p>
            <p>韧性剪切带既是强烈的线状应变带，也是线状的变质作用带。伴随着变形作用，剪切带内岩石和矿物中形成一定的应力梯度和化学浓度梯度，为流体及组分的运动提供了驱动力，开辟了通道。</p>
            <p>流体和组分的运动,导致流体与岩石、矿物之间或岩石、矿物的组分与组分之间的不平衡，从而发生变质反应,使岩石间的差异变小，并使岩石发生软化。</p>
            <p>剪切带既是流体运移的主要通道，也是流体-岩石发生相互作用的主要场所。在剪切带的变质、变形作用过程中，流体-岩石相互作用主要表现为以下几种：变质作用，钾交代作用，脱硅作用，碳酸盐化作用，长英条带、硅质条带的生成等。</p>
          </div>
        </div>
      </section>
      ...
      <section class="section">
        <div class="section-header" @click="toggleSection('shearDirection')">
          <h2>剪切运动方向确定</h2>
          <span class="toggle-icon">{{ expandedSections.shearDirection ? '−' : '+' }}</span>
        </div>
        <div v-if="expandedSections.shearDirection" class="section-content">
          <div class="definition-card" style="border-left-color: #16a085;">
            ...
            <p>穿过剪切带的标志层往往呈"S"形弯曲,造成标志层在剪切带两盘明显位移,根据错开的方向可确定剪切方向，但应用这一方法时要注意先存标志层与剪切带之间的方位关系，否则会得出错误的结论。</p>
            <p>鞘褶皱枢纽的方向或垂直Y轴剖面上的褶皱倒向指示剪切方向。韧性剪切带内常发育两种面理平行于剪切带内的应变椭球的X，Y，面的剪切带内面理(S)，在剪切带内呈"S"型展布。</p>
            <p>糜棱岩面理(C)实际上是一系列平行于剪切带边界的间隔排列的小型强剪切应变带。</p>
            <p>常由更细小的颗粒或云母等矿物所组成,"S"型面理和"C"面理所交的锐夹角,指示剪切带的剪切方向。</p>
            <p>云母鱼构造多发育于石英云母片岩中。其两端发育由细粒的层状硅酸盐类矿物和长石等组成的尾部，代表强剪切应变的微剪切带。与S-C组构一样，其锐夹角指示剪切方向。</p>
            <p>韧性剪切带内压力影构造呈不对称状，坚硬单体两侧的纤维状的结晶尾呈单斜对称。据此可以确定剪切方向。</p>
            <p>糜棱岩中的较强硬的碎斑，在递进剪切作用下产生破裂并旋转，使每个碎片向剪切方向倾斜，尤如一叠书被推倒，形成"多米诺骨牌"构造。其裂面与剪切带的锐夹角指示剪切带的剪切指向。</p>
            <p>糜棱岩中的碎班或矿物集合体、侵入岩体中的捕虏体等，在递进剪切作用下,使其一侧被拉长(或拉断)，形成曲颈瓶状。曲颈弯曲方向表示剪切带的剪切方向。</p>
            <p>与小型剪切带相比，准确鉴定大型的、结构和变形历史复杂的剪切带的剪切方向更加困难。</p>
            <p>需要从不同尺度，全面地收集剪切带内和带外变形特征，再进行更多复杂的研究才可能判断大型剪切带复杂的运动。</p>
          </div>
        </div>
      </section>
    </main>

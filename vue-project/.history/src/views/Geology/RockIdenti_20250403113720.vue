          ...
          >
            ...
            >
              <div class="igneous-content">
                ...
                <div class="rock-identification-container">
                  <h3 class="rock-class-title">①、橄榄岩-苦橄岩类</h3>

                  <div class="rock-characteristics">
                    <div class="specimen-characteristics">
                      <h4 class="characteristics-title">手标本特征</h4>
                        ...
                        <div class="rock-type">
                          ...
                          <div class="rock-sample">
                            <img
                              ...
                              alt="纯橄榄岩"
                            />
                            <span class="sample-label">纯橄榄岩标本</span>
                          </div>
                        </div>
                        ...
                        <div class="rock-type">
                          ...
                          <div class="rock-sample">
                            <img
                              ...
                              alt="辉石岩"
                            />
                            <span class="sample-label">辉石岩标本</span>
                          </div>
                        </div>
                    ...
                    <div class="microscopic-characteristics">
                      <h4 class="characteristics-title">镜下特征</h4>
                      <div class="characteristics-details">
                        <div class="microscopic-detail">
                          <p>
                            <strong>纯橄榄岩：</strong
                            >橄榄石呈自形粒状或他形粒状。
                          </p>
                        ...
                        <div class="microscopic-detail">
                          ...
                          <div class="microscopic-sample">
                            <img
                              src="@/assets/RockIdenti/蛇纹石化橄榄岩.jpg"
                              alt="蛇纹石化橄榄岩"
                            />
                            <span class="sample-label">蛇纹石化橄榄岩镜下</span>
                          </div>
                        </div>
                        <div class="microscopic-detail">
                          <div class="microscopic-sample">
                            <img
                              ...
                              alt="苦橄岩"
                            />
                            <span class="sample-label">苦橄岩镜下</span>
                          </div>
                        </div>
                      </div>
                    </div>
...
.rock-sample img:hover,
.microscopic-sample img:hover {

...
// 冲积扇
// 静态导入图片
import alluvialFanImage1 from "@/assets/FeatureRecog/10冲积扇/新疆塔克拉玛干沙漠的冲积扇.jpg";
import alluvialFanImage2 from "@/assets/FeatureRecog/10冲积扇/伊朗南部冲积扇图.jpg";
import alluvialFanImage3 from "@/assets/FeatureRecog/10冲积扇/埃及东北部冲积扇.jpg";

const currentIndex4 = ref(0);
const slideCount4 = 3;

const carouselSlides4 = ref([
  {
    image: alluvialFanImage1,
    title: "新疆塔克拉玛干沙漠的冲积扇",
    theme: "theme-desert",
  },
  {
    image: alluvialFanImage2,
    title: "伊朗南部冲积扇",
    theme: "theme-desert",
  },
  {
    image: alluvialFanImage3,
    title: "埃及东北部冲积扇",
    theme: "theme-desert",
  },
]);
...
// 计算轨道偏移样式
const trackStyle4 = computed(() => ({
  transform: `translateX(-${currentIndex4.value * 100}%)`,
}));

// 上一张
const prevSlide4 = () => {
  currentIndex4.value = (currentIndex4.value - 1 + slideCount4) % slideCount4;
};

// 下一张
const nextSlide4 = () => {
  currentIndex4.value = (currentIndex4.value + 1) % slideCount4;
};

// 跳转到指定幻灯片
const goToSlide4 = (index) => {
  currentIndex4.value = index;
};

// 三角洲相
// 静态导入图片
import deltaFaciesImage1 from "@/assets/FeatureRecog/08三角洲相/尼罗河三角洲.jpg";
import deltaFaciesImage2 from "@/assets/FeatureRecog/08三角洲相/多瑙河三角洲.jpg";
import deltaFaciesImage3 from "@/assets/FeatureRecog/08三角洲相/恒河三角洲.jpg";

const currentIndex3 = ref(0);
const slideCount3 = 3;

const carouselSlides3 = ref([
  {
    image: deltaFaciesImage1,
    title: "尼罗河三角洲",
    theme: "theme-marine",
  },
  {
    image: deltaFaciesImage2,
    title: "多瑙河三角洲",
    theme: "theme-marine",
  },
  {
    image: deltaFaciesImage3,
    title: "恒河三角洲",
    theme: "theme-marine",
  },
]);
...
// 计算轨道偏移样式
const trackStyle3 = computed(() => ({
  transform: `translateX(-${currentIndex3.value * 100}%)`,
}));

// 上一张
const prevSlide3 = () => {
  currentIndex3.value = (currentIndex3.value - 1 + slideCount3) % slideCount3;
};

// 下一张
const nextSlide3 = () => {
  currentIndex3.value = (currentIndex3.value + 1) % slideCount3;
};
...
const trackStyle2 = computed(() => ({
  transform: `translateX(-${currentIndex2.value * 100}%)`,
}));

// 上一张
const prevSlide2 = () => {
  currentIndex2.value = (currentIndex2.value - 1 + slideCount2) % slideCount2;
};

// 下一张
const nextSlide2 = () => {
  currentIndex2.value = (currentIndex2.value + 1) % slideCount2;
};
...
const trackStyle1 = computed(() => ({
  transform: `translateX(-${currentIndex1.value * 100}%)`,
}));

// 上一张
const prevSlide1 = () => {
  currentIndex1.value = (currentIndex1.value - 1 + slideCount1) % slideCount1;
};

// 下一张
const nextSlide1 = () => {
  currentIndex1.value = (currentIndex1.value + 1) % slideCount1;
};
          ...
          >
            ...
            <div class="subfacies-section">
              ...
              >
                ...
                <div class="geo-image-wrapper proportional">
                  <img
                    src="@/assets/FeatureRecog/07河流相/河漫滩（floodplain）.jpg"
                    class="geo-image"
                    alt="河漫滩（floodplain）"
                  />
                  <div class="geo-image-caption theme-marine">
                    河漫滩（floodplain）
                  </div>
                </div>
              </div>
              ...
              <div class="river-comparison">
                ...
                >
                  <div class="geo-image-group uniform-height">
                    <div class="geo-image-wrapper">
                      <img
                        src="@/assets/FeatureRecog/07河流相/辫状河.jpg"
                        class="geo-image"
                        alt="辫状河"
                      />
                      <div class="geo-image-caption theme-marine">辫状河</div>
                    </div>
                    <div class="geo-image-wrapper">
                      <img
                        src="@/assets/FeatureRecog/07河流相/辫状河与心滩.jpg"
                        class="geo-image"
                        alt="辫状河与心滩"
                      />
                      <div class="geo-image-caption theme-marine">
                ...
                >
                  <div class="geo-image-container">
                    <div class="geo-image-wrapper proportional">
                      <img
                        src="@/assets/FeatureRecog/07河流相/网状河.jpg"
                        class="geo-image"
                        alt="网状河"
                      />
                      <div class="geo-image-caption theme-marine">网状河</div>
                    </div>
                  </div>
                  <p>
                    网状河（anastomosed
      ...
      <div class="content-section delta-facies" id="delta-facies">
        ...
        <div class="section-content">
          <div class="intro-section">
            <div class="geo-carousel">
              <!-- 轮播容器，使用transform实现滑动效果 -->
              <div class="geo-carousel-track" :style="trackStyle3">
                <div
                  v-for="(slide, index) in carouselSlides3"
                  :key="index"
                  class="geo-slide"
                >
                  <div class="geo-image-wrapper">
              ...
              <!-- 导航控制 -->
              <div class="geo-carousel-controls">
                <button class="geo-carousel-btn prev" @click="prevSlide3">
                  ‹
                </button>
                <div class="geo-carousel-dots">
                  <button
                    v-for="(_, index) in carouselSlides3"
                    :key="index"
                    class="geo-carousel-dot"
                    :class="{ active: currentIndex3 === index }"
                    @click="goToSlide3(index)"
                  ></button>
                </div>
                <button class="geo-carousel-btn next" @click="nextSlide3">
                  ›
                </button>
              </div>
            </div>
              ...
              <div class="subtype-content">
                ...
                >
                  ...
                  <div class="geo-image-container">
                    <div class="geo-image-wrapper proportional">
                      <img
                        src="@/assets/FeatureRecog/08三角洲相/鸟足状三角洲（密西西比河三角洲.jpg"
                        class="geo-image"
                        alt="鸟足状三角洲（密西西比河三角洲）"
                      />
                      <div class="geo-image-caption theme-marine">
                ...
                >
                  ...
                  <div class="geo-image-container">
                    <div class="geo-image-wrapper proportional">
                      <img
                        src="@/assets/FeatureRecog/08三角洲相/朵状三角洲（黄河三角洲）.jpg"
                        class="geo-image"
                        alt="朵状三角洲（黄河三角洲）"
                      />
                      <div class="geo-image-caption theme-marine">
            ...
            <div v-show="activeDeltaType === 'wave'" class="delta-type-content">
              <div class="river-characteristics">
                ...
                <div class="geo-image-container">
                  <div class="geo-image-wrapper proportional">
                    <img
                      src="@/assets/FeatureRecog/08三角洲相/浪控三角洲（Rio Grijalva三角洲）.jpg"
                      class="geo-image"
                      alt="浪控三角洲（Rio Grijalva三角洲）"
                    />
                    <div class="geo-image-caption theme-marine">
                      浪控三角洲（Rio Grijalva三角洲）
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div v-show="activeDeltaType === 'tide'" class="delta-type-content">
              <div class="river-characteristics">
                ...
                <div class="geo-image-container">
                  <div class="geo-image-wrapper proportional">
                    <img
                      src="@/assets/FeatureRecog/08三角洲相/潮控三角洲（珠江三角洲）.jpg"
                      class="geo-image"
                      alt="浪潮控三角洲（珠江三角洲）"
                    />
                    <div class="geo-image-caption theme-marine">
        ...
        <div class="section-content">
          <div class="intro-section">
            <div class="geo-image-container">
              <div class="geo-image-wrapper proportional">
                <img
                  src="@/assets/FeatureRecog/09湖泊相/湖泊1.jpg"
                  class="geo-image"
                  alt="湖泊"
                />
                <div class="geo-image-caption theme-marine">湖泊</div>
              </div>
            </div>
            <p>
              ...
              <div class="hydrodynamic-section">
                ...
                >
                  ...
                  >
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/湖泊中的潮汐作用.jpg"
                          class="geo-image"
                          alt="湖泊中的潮汐作用"
                        />
                        <div class="geo-image-caption theme-marine">
                      ...
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/浪蚀湖岸.jpg"
                          class="geo-image"
                          alt="浪蚀湖岸"
                        />
                        <div class="geo-image-caption theme-marine">
                      ...
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/湖滩.jpg"
                          class="geo-image"
                          alt="湖滩"
                        />
                        <div class="geo-image-caption theme-marine">湖滩</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/河流入湖.jpg"
                          class="geo-image"
                          alt="河流入湖"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                >
                  ...
                  >
                    ...
                    <div class="geo-image-wrapper proportional">
                      <img
                        src="@/assets/FeatureRecog/09湖泊相/湖泊3.jpg"
                        class="geo-image"
                        alt="湖泊"
                      />
                      <div class="geo-image-caption theme-marine">湖泊</div>
                ...
                >
                  ...
                  <div v-show="lakeSubfacies.deep" class="subfacies-detail">
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/页岩.jpg"
                          class="geo-image"
                          alt="页岩"
                        />
                        <div class="geo-image-caption theme-marine">页岩</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/San Nicandro Fm厚粉质矿床剖面（深湖相）.jpg"
                          class="geo-image"
                          alt="San Nicandro Fm厚粉质矿床剖面（深湖相）"
                        />
                        <div class="geo-image-caption theme-marine">
                          San Nicandro Fm厚粉质矿床剖面（深湖相）
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div v-show="lakeSubfacies.shallow" class="subfacies-detail">
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/鲕粒灰岩.jpg"
                          class="geo-image"
                          alt="鲕粒灰岩"
                        />
                        <div class="geo-image-caption theme-marine">
                      ...
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/湖相交错层理.jpg"
                          class="geo-image"
                          alt="湖相交错层理"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                >
                  ...
                  <div v-show="lakeSubfacies.expanded" class="subfacies-detail">
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/湖相泥岩与灰岩.jpg"
                          class="geo-image"
                          alt="湖相泥岩与灰岩"
                        />
                        <div class="geo-image-caption theme-marine">
                      ...
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/坳陷盆地湖泊.jpg"
                          class="geo-image"
                          alt="坳陷盆地湖泊"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                >
                  ...
                  >
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/交错层理.jpg"
                          class="geo-image"
                          alt="交错层理"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                >
                  ...
                  >
                    ...
                    <div class="geo-image-group uniform-height">
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/介形虫.jpg"
                          class="geo-image"
                          alt="介形虫"
                        />
                        <div class="geo-image-caption theme-marine">介形虫</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/轮藻.jpg"
                          class="geo-image"
                          alt="轮藻"
                        />
                        <div class="geo-image-caption theme-marine">轮藻</div>
                      </div>
                      <div class="geo-image-wrapper">
                        <img
                          src="@/assets/FeatureRecog/09湖泊相/湖底含化石钙质页岩.jpg"
                          class="geo-image"
                          alt="湖底含化石钙质页岩"
                        />
                        <div class="geo-image-caption theme-marine">
      ...
      <div class="content-section alluvial-fan" id="alluvial-fan">
        ...
        <div class="section-content">
          <div class="intro-section">
            <div class="geo-carousel">
              <!-- 轮播容器，使用transform实现滑动效果 -->
              <div class="geo-carousel-track" :style="trackStyle4">
                <div
                  v-for="(slide, index) in carouselSlides4"
                  :key="index"
                  class="geo-slide"
                >
                  <div class="geo-image-wrapper">
              ...
              <!-- 导航控制 -->
              <div class="geo-carousel-controls">
                <button class="geo-carousel-btn prev" @click="prevSlide4">
                  ‹
                </button>
                <div class="geo-carousel-dots">
                  <button
                    v-for="(_, index) in carouselSlides4"
                    :key="index"
                    class="geo-carousel-dot"
                ...
                <button class="geo-carousel-btn next" @click="nextSlide4">
                  ›
                </button>
              </div>
            </div>
                ...
                >
                  ...
                  <div v-show="expandedClimate.arid" class="climate-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/10冲积扇/阿尔金山.jpg"
                          class="geo-image"
                          alt="阿尔金山"
                        />
                        <div class="geo-image-caption theme-desert">
                ...
                >
                  ...
                  <div v-show="expandedClimate.humid" class="climate-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/10冲积扇/柯西河冲积扇.jpg"
                          class="geo-image"
                          alt="柯西河冲积扇"
                        />
                        <div class="geo-image-caption theme-desert">
            ...
            <div class="content-card">
              ...
              <div class="deposition-types">
                ...
                <div class="geo-image-group uniform-height">
                  <div class="geo-image-wrapper">
                    <img
                      src="@/assets/FeatureRecog/10冲积扇/喜马拉雅山泥石流通道.jpg"
                      class="geo-image"
                      alt="喜马拉雅山泥石流通道"
                    />
                    <div class="geo-image-caption theme-desert">
                  ...
                  <div class="geo-image-wrapper">
                    <img
                      src="@/assets/FeatureRecog/10冲积扇/河道沉积1.jpg"
                      class="geo-image"
                      alt="河道沉积"
                    />
                    <div class="geo-image-caption theme-desert">河道沉积</div>
                  </div>
                  <div class="geo-image-wrapper">
                    <img
                      src="@/assets/FeatureRecog/10冲积扇/片流沉积1.jpg"
                      class="geo-image"
                      alt="片流沉积"
                    />
                    <div class="geo-image-caption theme-desert">片流沉积</div>
                  </div>
                  <div class="geo-image-wrapper">
                    <img
                      src="@/assets/FeatureRecog/10冲积扇/筛状沉积2.jpg"
                      class="geo-image"
                      alt="筛状沉积"
                    />
                    <div class="geo-image-caption theme-desert">筛状沉积</div>
                  </div>
                </div>
                    ...
                    >
                      ...
                      <div v-show="basinTypes.wide" class="type-detail">
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/11裂陷盆地/渤海湾.jpg"
                              class="geo-image"
                              alt="渤海湾"
                            />
                            <div class="geo-image-caption theme-fluvial">
                    ...
                    >
                      ...
                      <div v-show="basinTypes.narrow" class="type-detail">
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/11裂陷盆地/东非裂谷.jpg"
                              class="geo-image"
                              alt="东非裂谷"
                            />
                            <div class="geo-image-caption theme-fluvial">
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/11裂陷盆地/红海裂谷2.jpg"
                              class="geo-image"
                              alt="红海裂谷"
                            />
                            <div class="geo-image-caption theme-fluvial">
                    ...
                    >
                      ...
                      <div v-show="basinTypes.failed" class="type-detail">
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/11裂陷盆地/贝努埃裂谷（Benue rift）.jpg"
                              class="geo-image"
                              alt="贝努埃裂谷（Benue rift）"
                            />
                            <div class="geo-image-caption theme-fluvial">
                              贝努埃裂谷（Benue rift）
                            </div>
                    ...
                    >
                      ...
                      <div v-show="basinTypes.oceanic" class="type-detail">
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/11裂陷盆地/大西洋中脊.jpg"
                              class="geo-image"
                              alt="大西洋中脊"
                            />
                            <div class="geo-image-caption theme-fluvial">
                    ...
                    >
                      ...
                      <div v-show="basinTypes.passive" class="type-detail">
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/11裂陷盆地/大西洋盆地.jpg"
                              class="geo-image"
                              alt="大西洋盆地"
                            />
                            <div class="geo-image-caption theme-fluvial">
                ...
                <div class="classification-group">
                  ...
                  >
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/11裂陷盆地/莱茵地堑.jpg"
                          class="geo-image"
                          alt="莱茵地堑"
                        />
                        <div class="geo-image-caption theme-fluvial">
        ...
        <div class="section-content">
          <div class="intro-section">
            <div class="geo-image-container">
              <div class="geo-image-wrapper proportional">
                <img
                  src="@/assets/FeatureRecog/12海相沉积/海洋图片2.jpg"
                  class="geo-image"
                  alt="海洋"
                />
                <div class="geo-image-caption theme-marine">海洋</div>
              </div>
            </div>
                ...
                <div class="terrain-card" @click="toggleTerrainDetail('shelf')">
                  ...
                  <div v-show="terrainDetails.shelf" class="terrain-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/大陆架(陆棚).jpg"
                          class="geo-image"
                          alt="大陆架(陆棚)"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                <div class="terrain-card" @click="toggleTerrainDetail('slope')">
                  ...
                  <div v-show="terrainDetails.slope" class="terrain-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/海底峡谷.jpg"
                          class="geo-image"
                          alt="海底峡谷"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                <div class="terrain-card" @click="toggleTerrainDetail('rise')">
                  ...
                  <div v-show="terrainDetails.rise" class="terrain-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/大陆边缘.jpg"
                          class="geo-image"
                          alt="大陆边缘"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                <div class="terrain-card" @click="toggleTerrainDetail('basin')">
                  ...
                  <div v-show="terrainDetails.basin" class="terrain-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/深海盆地.jpg"
                          class="geo-image"
                          alt="深海盆地"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                <div class="hydro-card" @click="toggleHydroDetail('wave')">
                  ...
                  <div v-show="hydroDetails.wave" class="hydro-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/波浪.jpg"
                          class="geo-image"
                          alt="波浪"
                        />
                        <div class="geo-image-caption theme-marine">波浪</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="hydro-card" @click="toggleHydroDetail('tide')">
                  ...
                  <div v-show="hydroDetails.tide" class="hydro-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/潮汐.jpg"
                          class="geo-image"
                          alt="潮汐"
                        />
                        <div class="geo-image-caption theme-marine">潮汐</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="hydro-card" @click="toggleHydroDetail('current')">
                  ...
                  <div v-show="hydroDetails.current" class="hydro-detail">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/海流图片.jpg"
                          class="geo-image"
                          alt="海流"
                        />
                        <div class="geo-image-caption theme-marine">海流</div>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        >
                          ...
                          <div v-show="features.island" class="feature-detail">
                            ...
                            <div class="geo-image-container">
                              <div class="geo-image-wrapper proportional">
                                <img
                                  src="@/assets/FeatureRecog/12海相沉积/障壁岛.jpg"
                                  class="geo-image"
                                  alt="障壁岛"
                                />
                                <div class="geo-image-caption theme-marine">
                        ...
                        >
                          ...
                          <div v-show="features.lagoon" class="feature-detail">
                            ...
                            <div class="geo-image-container">
                              <div class="geo-image-wrapper proportional">
                                <img
                                  src="@/assets/FeatureRecog/12海相沉积/潟湖.jpg"
                                  class="geo-image"
                                  alt="潟湖"
                                />
                                <div class="geo-image-caption theme-marine">
                        ...
                        >
                          ...
                          <div v-show="features.tidal" class="feature-detail">
                            ...
                            <div class="geo-image-container">
                              <div class="geo-image-wrapper proportional">
                                <img
                                  src="@/assets/FeatureRecog/12海相沉积/潮坪1.jpg"
                                  class="geo-image"
                                  alt="潮坪"
                                />
                                <div class="geo-image-caption theme-marine">
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/12海相沉积/高能海岸带.jpg"
                              class="geo-image"
                              alt="高能海岸带"
                            />
                            <div class="geo-image-caption theme-marine">
                    ...
                    >
                      ...
                      <div v-show="shelfTypes.tidal" class="shelf-detail">
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/12海相沉积/潮汐图片.jpg"
                              class="geo-image"
                              alt="潮汐"
                            />
                            <div class="geo-image-caption theme-marine">
                    ...
                    >
                      ...
                      <div v-show="shelfTypes.storm" class="shelf-detail">
                        ...
                        <div class="geo-image-container">
                          <div class="geo-image-wrapper proportional">
                            <img
                              src="@/assets/FeatureRecog/12海相沉积/风暴流.jpg"
                              class="geo-image"
                              alt="风暴流"
                            />
                            <div class="geo-image-caption theme-marine">
                ...
                <div class="env-group" @click="toggleEnvGroup('bathyal')">
                  ...
                  <div v-show="envGroups.bathyal" class="env-content">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/半深海相沉积.jpg"
                          class="geo-image"
                          alt="半深海相沉积"
                        />
                        <div class="geo-image-caption theme-marine">
                ...
                <div class="env-group" @click="toggleEnvGroup('abyssal')">
                  ...
                  <div v-show="envGroups.abyssal" class="env-content">
                    ...
                    <div class="geo-image-container">
                      <div class="geo-image-wrapper proportional">
                        <img
                          src="@/assets/FeatureRecog/12海相沉积/深海沉积物1.jpg"
                          class="geo-image"
                          alt="深海沉积物"
                        />
                        <div class="geo-image-caption theme-marine">

      ...
      >
        ...
        <section class="section">
          ...
          <div v-if="expandedSections.foliation" class="section-content">
            ...
            <div class="geo-image-group">
              <div class="geo-image-container">
                <img src="@/assets/StructureField/03劈理和线理/面状构造.jpg" alt="面状构造" class="geo-image geo-image-middle" />
                <div class="geo-image-caption">面状构造</div>
              </div>
              <div class="geo-image-container">
                <img src="@/assets/StructureField/03劈理和线理/线状构造1.jpg" alt="线状构造" class="geo-image geo-image-middle" />

...
import rhyoliteImg from "@/assets/RockIdenti/流纹岩.jpg";
import rhyodaciteImg from "@/assets/RockIdenti/流纹英安岩.jpg";
import obsidianImg from "@/assets/RockIdenti/黑曜岩.jpg";
import perliteImg from "@/assets/RockIdenti/珍珠岩.jpg";
import pitchstoneImg from "@/assets/RockIdenti/松脂岩.jpg";
import nephelineSyeniteImg from "@/assets/RockIdenti/霞石正长岩.jpg";
import nephelineSyenitePorphyryImg from "@/assets/RockIdenti/霞石正长斑岩.jpg";
import leucititeImg from "@/assets/RockIdenti/白榴石响岩.jpg";
import lamprophyreImg from "@/assets/RockIdenti/云煌岩.jpg";
...
const graniticRocks = [
  {
    ...
    macro:
      "为花岗岩向闪长岩的过渡岩石，斜长石＞钾长石，石英约20%，暗色矿物10%-15%，颜色灰绿或暗灰",
    micro:
      "石英约20%，斜长石占长石的65%-90%，碱性长石占35%以下，暗色矿物以角闪石为主",
  },
  {
    name: "花岗斑岩",
    image: granitePorphyryImg,
    macro:
      "成分相当于花岗岩的浅成岩，全晶质、斑状结构，斑晶主要是碱性长石和石英",
    micro: "斑晶为碱性长石和石英，有时有黑云母、角闪石，基质为隐晶至微晶结构",
  },
  // 其他岩石数据...
];

// 霞石正长岩-响岩类数据
const nephelineRocks = [
  {
    name: "霞石正长岩",
    image: nephelineSyeniteImg,
    macro:
      "由长板状的正长石组成，次为霞石(深肉红色，粒状，油脂光泽)和碱性暗色矿物",
    micro: "主要为正长石和霞石，含碱性辉石和碱性角闪石",
  },
  // 其他岩石数据...
];
...
const lamprophyreRocks = [
  {
    name: "云煌岩",
    image: lamprophyreImg,
    macro: "主要成分为黑云母和正长石，黑云母多呈褐色，斑状结构",
    micro: "黑云母自形程度好，有时可见斜长石的环带",
  },
  // 其他岩石数据...
];
...
const nephelineCurrentSlide = ref(0);
...
// 计算属性
const nephelineCarouselStyle = computed(() => ({
  transform: `translateX(-${nephelineCurrentSlide.value * 100}%)`,
}));

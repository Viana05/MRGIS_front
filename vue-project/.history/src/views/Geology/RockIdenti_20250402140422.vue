...
<template>
  <div class="geology-container">
    ...
    <p>火成岩又称岩浆岩，是在岩石循环过程中产生的三大岩类的一种...</p>
    ...
    <div class="rock-image-container">
      <img 
        ...
        alt="典型岩浆岩示例"
      >
      <div class="image-caption">图1: 典型岩浆岩地貌 - 丹·布里斯特岩柱</div>
    </div>
    
    <p>火成岩可以分为两种基本类型。第一种为<span class="rock-term term-primary">侵入岩...</span></p>
    ...
    <div class="rock-image-container">
      <img 
        ...
        alt="玄武岩示例"
      >
      <div class="image-caption">图2: 喷出岩形成的玄武岩柱状节理</div>
    </div>
  </div>
        </div>

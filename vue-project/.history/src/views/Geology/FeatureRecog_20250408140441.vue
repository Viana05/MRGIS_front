        ...
        <div class="timeline">
          ...
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              <div class="geo-image-group uniform-height">
                <div class="geo-image-wrapper">
                  <img src="@/assets/FeatureRecog/01历史回望/丹麦学者 N. Steno.jpg" class="geo-image" alt="丹麦学者 N. Steno" />
                  <div class="geo-image-caption theme-desert">丹麦学者 N. Steno</div>
                </div>
                <div class="geo-image-wrapper">
                  <img src="@/assets/FeatureRecog/01历史回望/英国地质学家w. Smith.jpg" class="geo-image" alt="英国地质学家w. Smith" />
                  <div class="geo-image-caption theme-desert">英国地质学家w. Smith</div>
                </div>
              </div>
          ...
          <div class="timeline-item">
            ...
            <div class="timeline-content">
              ...
              <div class="geo-image-group uniform-height">
                <div class="geo-image-wrapper">
                  <img src="@/assets/FeatureRecog/01历史回望/《地层学原理》(1913).jpg" class="geo-image" alt="《地层学原理》(1913)" />
                  <div class="geo-image-caption theme-desert">《地层学原理》(1913)</div>
                </div>
                <div class="geo-image-wrapper">
                  <img src="@/assets/FeatureRecog/01历史回望/《国际地层指南》（简化版）.jpg" class="geo-image" alt="《国际地层指南》（简化版）" />
                  <div class="geo-image-caption theme-desert">《国际地层指南》（简化版）</div>
                </div>
              </div>
              <p class="stage-theory">

...
<template>
  <div class="geology-observation-system">
    ...
    <main class="content">
        ...
        <section class="section">
          <div class="section-header" @click="toggleSection('mountain')">
            ...
            <div v-if="expandedSections.mountain" class="section-content">
              ...
              <!-- 褶皱山 -->
              <div class="geo-concept-card" style="border-left-color: #8e44ad">
                <h3>褶皱山</h3>
                <p>
                ...
                <div class="geo-subtypes">
                  <div class="geo-subtype" style="border-left-color: #e74c3c">
                    <h4>背斜山</h4>
                    <p>
                  ...
                  <div class="geo-subtype" style="border-left-color: #3498db">
                    <h4>向斜山</h4>
                    <p>
                  ...
                  <div class="geo-subtype" style="border-left-color: #f39c12">
                    <h4>单面山</h4>
                    <p>
      ...
      <div v-if="expandedSections.mountain" class="section-content">
        <!-- 断块山 -->
        <div class="geo-concept-card" style="border-left-color: #9b59b6">
          <h3>断块山</h3>
          <p>
          ...
          <div class="geo-subtypes">
            <div class="geo-subtype" style="border-left-color: #16a085">
              <h4>地垒式断块山</h4>
              <p>
            ...
            <div class="geo-subtype" style="border-left-color: #2ecc71">
              <h4>掀斜式断块山</h4>
              <p>
          ...
          <div class="geo-examples">
            ...
            <ul>
              <li>
                <strong>华山</strong>：我国著名的五岳之一，整体为花岗岩断块山
              </li>
              <li>
        ...
        <!-- 火山 -->
        <div class="geo-concept-card" style="border-left-color: #e74c3c">
          <h3>火山</h3>
          <p>
          ...
          <div class="geo-subtypes">
            ...
            <div class="geo-subtype" style="border-left-color: #95a5a6">
              <h4>死火山</h4>
              <p>
          ...
          <div class="geo-examples">
            ...
            <ul>
              <li>
                <strong>冒纳罗亚火山</strong>：夏威夷海岛上的一个活跃盾状活火山
              </li>
              <li>
        ...
        <!-- 冠状山 -->
        <div class="geo-concept-card" style="border-left-color: #3498db">
          <h3>冠状山</h3>
          <p>
        ...
        <section class="geo-section">
          ...
          <div class="geo-section-content">
            ...
            <div class="geo-concept-card" style="border-left-color: #8e44ad">
              <h3>构造板块</h3>
              <p>
                基于机械性能和传热方法的差异，地球的外层可分为岩石圈（lithosphere）和软流圈（asthenosphere）。
              </p>
              <p>
            ...
            <div class="geo-concept-card" style="border-left-color: #9b59b6">
              <h3>板块运动驱动力</h3>
              <p>
                人们普遍认为，由于岩石圈和软流圈的特征，构造板块是移动的。尽管仍有争论，但一个多数人接受的观点是：由于在俯冲带中下沉的洋壳密度过大，形成了板块运动的强大动力源。
              </p>

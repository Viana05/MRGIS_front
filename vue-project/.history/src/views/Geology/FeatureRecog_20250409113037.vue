      ...
      <div class="content-section chrono-stratigraphy" id="chrono-stratigraphy">
        ...
        <div class="section-content">
          <div class="definition-section">
            <div class="geo-image-group uniform-height">
              <div class="geo-image-wrapper">
                <img src="@/assets/FeatureRecog/04年代地层/年代地层学.jpg" class="geo-image" alt="年代地层学" />
                <div class="geo-image-caption theme-lake">年代地层学</div>
              </div>
              <div class="geo-image-wrapper">
                <img src="@/assets/FeatureRecog/04年代地层/年代地层单位.jpg" class="geo-image" alt="年代地层单位" />
                <div class="geo-image-caption theme-lake">年代地层单位</div>
              </div>
            </div>
            <p>

    ...
    <el-tab-pane>
      ...
      <div class="demo-collapse">
        <el-collapse v-model="activeNames2" accordion>
          ...
          <el-collapse-item title="06沉积相" name="10"> </el-collapse-item>
          <el-collapse-item title="07河流相" name="10"> </el-collapse-item>
          <el-collapse-item title="08三角洲相" name="10"> </el-collapse-item>
          <el-collapse-item title="09湖泊相" name="10"> </el-collapse-item>
          <el-collapse-item title="10冲积扇" name="10"> </el-collapse-item>
          <el-collapse-item title="11裂陷盆地" name="10"> </el-collapse-item>
          <el-collapse-item title="12海相沉积" name="10"> </el-collapse-item>
        </el-collapse>
      </div>
    </el-tab-pane>
  </el-tabs>

              ...
              <div class="classification-section">
                ...
                >
                  ...
                  <div
                    ...
                    class="group-details"
                  >
                    <div class="basin-type" @click="toggleBasinType('sag')">
                      <h5>伸展型拗陷盆地</h5>
                    ...
                    <div class="basin-type" @click="toggleBasinType('wide')">
                      <h5>陆内宽裂陷盆地</h5>
                    ...
                    <div class="basin-type" @click="toggleBasinType('narrow')">
                      <h5>陆内窄裂陷盆地</h5>
                ...
                >
                  ...
                  >
                    <div
                      class="basin-type"
                      @click="toggleBasinType('intercontinental')"
                    >
                      <h5>陆间裂谷或原始大洋裂谷</h5>
                      <div
                    ...
                    <div class="basin-type" @click="toggleBasinType('failed')">
                      <h5>衰退裂谷</h5>
                    ...
                    <div class="basin-type" @click="toggleBasinType('oceanic')">
                      <h5>新生大洋盆地和洋中脊</h5>
                    ...
                    <div class="basin-type" @click="toggleBasinType('passive')">
                      <h5>被动大陆边缘</h5>

          ...
          <el-collapse v-model="activeNames" accordion class="rock-collapse">
            ...
            >
              ...
              <p class="highlight-success">
                <strong>角砾岩</strong>是由从母岩上破碎下来的，颗粒直径大于2毫米的碎屑，经过搬运、沉积、压实、胶结而形成的岩石。组成角砾岩的碎屑物质，一般因原地堆积或搬运距离很短，因此磨圆度极低，分选很差，形状各异，棱角分明。角砾岩能很好反映母岩成分和性质，它与母岩关系较砾岩更为密切。角砾岩最常见的形成位置之一是露头的底部，物理风化碎屑堆积处。另一种是在离露头不远的河流沉积物或冲积扇上。
              </p>
              <p class="highlight-success">
                <strong>砾岩</strong>是一种由从母岩上破碎下来的，颗粒直径大于2毫米的碎屑，经过搬运、沉积、压实、胶结而形成的岩石。砾岩比较粗糙，可以见到明显的砾石，如果胶结成岩石的砾石具有棱角，则称为角砾岩。
              </p>
              <p class="highlight-success">
                <strong>砂岩</strong>主要由各种砂粒胶结而成的，颗粒直径在0.05-2mm，其中砂粒含量要大于50%，结构稳定，通常呈淡褐色或红色，主要含硅、钙、黏土和氧化铁。
              </p>
              <p class="highlight-success">
                <strong>粉砂岩</strong>由粒径为0.0625～0.0039毫米的粉砂的含量占50%以粉砂岩标本的一种碎屑沉积岩。粉砂岩的颜色多种多样，随混入物的成分不同而变。粉砂岩是在经过了长距离搬运、水动力条件比较安静、沉积速度缓慢的环境下形成的。
              </p>
              <div class="rock-comparison-container">
                <!-- 角砾岩 -->
                <div class="comparison-image-wrapper">
              ...
              <p class="highlight-purple">
                <strong>白垩岩</strong>是一种软质、白色、多孔的沉积碳酸盐岩，是一种由方解石组成的石灰岩。它是在相当深的海洋条件下，由一种叫做颗石藻的微生物脱落下来的细小方解石壳逐渐堆积而成的。
              </p>
              <p class="highlight-purple">
                <strong>贝壳灰岩</strong>是一种由完整的生物贝壳被泥晶方解石固结而成的石灰岩。
              </p>
              <p>
            ...
            >
              ...
              <p class="highlight-teal">
                <strong>千枚岩</strong>是具有千枚状构造的低级变质岩石。原岩通常为泥质岩石（或含硅质、钙质、炭质的泥质岩）、粉砂岩及中、酸性凝灰岩等。
              </p>
              <p class="highlight-teal">
                <strong>片岩</strong>是具有典型的片状构造的变质岩一种，是区域变质的产物。片状，板状，纤维状矿物相互平行排列，粒度较粗，肉眼可辨别。主要矿物为云母，石英，角闪石，绿泥石等。
              </p>
              <p class="highlight-teal">
                <strong>板岩</strong>是具有板状构造，基本没有重结晶的变质岩。原岩为泥质、粉质或中性凝灰岩，沿板理方向可以剥成薄片。
              </p>
              <p class="highlight-teal">
                <strong>大理岩</strong>是由碳酸盐岩经区域变质作用或接触变质作用形成的变质岩。主要由方解石和白云石组成，具粒状变晶结构，块状（有时为条带状）构造。
              </p>
              <p class="highlight-teal">
                <strong>石英岩</strong>是一种主要由石英组成的变质岩，多由石英砂岩或其他硅质岩石经变质作用，重结晶形成。石英岩一般为块状构造，粒状变晶结构，呈晶质集合体。
              </p>
              <div class="rock-comparison-container">
                <!-- 片麻岩 -->
                <div class="comparison-image-wrapper">
                  <img
                    ...
                    alt="片麻岩"
                  />
                  <span class="comparison-caption">片麻岩</span>
                </div>
                <!-- 千枚岩 -->
                <div class="comparison-image-wrapper">
                  <img

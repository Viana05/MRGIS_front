            ...
            <div class="comparison-section">
              <div class="river-comparison">
                ...
                >
                  <div class="geo-image-group uniform-height">
                    <div class="geo-image-wrapper">
                      <img src="@/assets/FeatureRecog/07河流相/辫状河.jpg" class="geo-image" alt="辫状河" />
                      <div class="geo-image-caption theme-marine">辫状河</div>
                    </div>
                    <div class="geo-image-wrapper">
                      <img src="@/assets/FeatureRecog/07河流相/辫状河与心滩.jpg" class="geo-image" alt="辫状河与心滩" />
                      <div class="geo-image-caption theme-marine">辫状河与心滩</div>
                    </div>
                  </div>
                  <p>
                    辫状河（ braided

...
// 水动力折叠控制
const expandedHydrodynamic = ref({
  wave: false,
  river: false,
  gravity: false,
});

const toggleHydrodynamic = (type) => {
  expandedHydrodynamic.value[type] = !expandedHydrodynamic.value[type];
};
...
const toggleSubfacies = (type) => {
  expandedSubfacies.value[type] = !expandedSubfacies.value[type];
};

// 特征折叠控制
const expandedCharacteristics = ref({
  rock: false,
  structure: false,
  fossil: false,
});

const toggleCharacteristic = (type) => {
  expandedCharacteristics.value[type] = !expandedCharacteristics.value[type];
};
        ...
        <div class="section-content">
            ...
            <div class="content-card">
              ...
              <div class="hydrodynamic-section">
                ...
                <div
                  ...
                  @click="toggleHydrodynamic('wave')"
                >
                  <h5>波浪和岸流作用</h5>
                  <div
                    v-show="expandedHydrodynamic.wave"
                ...
                <div
                  class="hydrodynamic-item"
                  @click="toggleHydrodynamic('river')"
                >
                  <h5>河流影响</h5>
                  <div
                    v-show="expandedHydrodynamic.river"
                    class="hydrodynamic-detail"
                  >
                    <p>
                ...
                <div
                  class="hydrodynamic-item"
                  @click="toggleHydrodynamic('gravity')"
                >
                  <h5>重力流沉积作用</h5>
                  <div
                    v-show="expandedHydrodynamic.gravity"
                    class="hydrodynamic-detail"
                  >
                    <p>
          ...
          <div v-show="activeLakeTab === 'types'" class="lake-types">
            ...
            <div class="content-card">
              ...
              <div class="subfacies-section">
                <div class="subfacies-card" @click="toggleSubfacies('deep')">
                  <h4>深湖和半深湖亚相</h4>
                  <div v-show="expandedSubfacies.deep" class="subfacies-detail">
                ...
                <div class="subfacies-card" @click="toggleSubfacies('shallow')">
                  <h4>浅湖亚相</h4>
                  <div
                    v-show="expandedSubfacies.shallow"
                ...
                <div
                  ...
                  @click="toggleSubfacies('littoral')"
                >
                  <h4>滨湖亚相</h4>
                  <div
                    v-show="expandedSubfacies.littoral"
                    class="subfacies-detail"
                  >
                    <p>
                ...
                <div
                  class="subfacies-card"
                  @click="toggleSubfacies('expanded')"
                >
                  <h4>扩张湖亚相</h4>
                  <div
                    v-show="expandedSubfacies.expanded"
                    class="subfacies-detail"
                  >
                    <p>
          ...
          <div v-show="activeLakeTab === 'markers'" class="lake-markers">
            ...
            <div class="content-card">
              ...
              <div class="rock-characteristics">
                ...
                <div
                  class="characteristic-card"
                  @click="toggleCharacteristic('rock')"
                >
                  <h5>岩石类型</h5>
                  <div
                    v-show="expandedCharacteristics.rock"
                ...
                <div
                  class="characteristic-card"
                  @click="toggleCharacteristic('structure')"
                >
                  <h5>沉积构造</h5>
                  <div
                    v-show="expandedCharacteristics.structure"
                    class="characteristic-detail"
                  >
                    <p>
                ...
                <div
                  class="characteristic-card"
                  @click="toggleCharacteristic('fossil')"
                >
                  <h5>生物化石</h5>
                  <div
                    v-show="expandedCharacteristics.fossil"
                    class="characteristic-detail"
                  >
                    <p>

...
const expandedSections = ref({
  ...
  foliationLineation: false, // 合并后的劈理和线理部分
  folds: false,
  foldTypes: false,
    ...
    <main class="content">
      ...
      >
        <section class="section">
          <div
            class="section-header"
            @click="toggleSection('foliationLineation')"
          >
            <h2>面状与线状构造</h2>
            <span class="toggle-icon">{{
              expandedSections.foliationLineation ? "−" : "+"
            }}</span>
          </div>
          <div
            v-if="expandedSections.foliationLineation"
            class="section-content"
          >
            <!-- 劈理部分 -->
            <div class="subsection">
              ...
              <!-- <div class="geo-image-group">
                <div class="geo-image-container">
                  ...
                  />
                  <div class="geo-image-caption">图1. 流劈理显微结构</div>
                </div>
                <div class="geo-image-container">
                  <img
                    src="foliation2.jpg"
                    ...
                    class="geo-image geo-image-medium"
                  />
                  <div class="geo-image-caption">图2. 破劈理野外露头</div>
                </div>
              </div> -->
              ...
              <div class="classification-card">
                <h4>劈理分类</h4>
                <p>按照传统分类方案，根据劈理的结构及其成因可将劈理分为...</p>
              </div>
            </div>
              ...
              <!-- <div class="geo-image-group">
                <div class="geo-image-container">
                  <img
                    ...
                    class="geo-image geo-image-medium"
                  />
                  <div class="geo-image-caption">图3. 拉伸线理特征</div>
                </div>
                <div class="geo-image-container">
                  <img
                    src="lineation2.jpg"
                    ...
                    class="geo-image geo-image-medium"
                  />
                  <div class="geo-image-caption">图4. 矿物生长线理</div>
                </div>
              </div> -->

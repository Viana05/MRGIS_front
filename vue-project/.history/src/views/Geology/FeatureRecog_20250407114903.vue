      ...
      <div class="content-section sedimentary-facies" id="sedimentary-facies">
        ...
        <div class="section-content">
          ...
          <div class="transitional-facies">
            ...
            <p>
              依据河流汇入的蓄水体盆地性质的不同，有海洋三角洲和湖泊三角洲之分。河口湾相属于海陆过渡相组。在构造沉降幅度大的海岸地区，一般都为潮汐作用很强的高潮差区，在此类海岸的河口地区，受潮汐和河流两个因素的作用。
            </p>
            <p>
...
.sedimentary-facies .section-title {
  color: #2c3e50;
...
.sedimentary-facies .subsection-title {
  color: #2980b9;
  margin: 15px 0 10px;
  padding-left: 10px;

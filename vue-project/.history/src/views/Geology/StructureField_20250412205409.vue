...
//褶皱图片数据
import wrinkleImage1 from "@/assets/StructureField/04褶皱/褶皱1.jpg";
import wrinkleImage2 from "@/assets/StructureField/04褶皱/褶皱2.jpg";
import wrinkleImage3 from "@/assets/StructureField/04褶皱/褶皱3.jpg";
import wrinkleImage4 from "@/assets/StructureField/04褶皱/褶皱4.jpg";
import wrinkleImage5 from "@/assets/StructureField/04褶皱/褶皱5.jpg";
...
const prevImage2 = () => {
  currentIndex2.value =
    (currentIndex2.value - 1 + images2.value.length) % images2.value.length;
};
...
//山脉形成图片数据
import mountImage1 from "@/assets/StructureField/07山脉形成/加拿大芒特索尔山.jpg";
import mountImage2 from "@/assets/StructureField/07山脉形成/巴基斯坦喀喇昆仑山.jpg";
import mountImage3 from "@/assets/StructureField/07山脉形成/南美罗奈马山.jpg";
import mountImage4 from "@/assets/StructureField/07山脉形成/加拿大阿斯加德山.jpg";
...
const currentImage4 = computed(() => images4.value[currentIndex4.value]);

const nextImage4 = () => {
  currentIndex4.value = (currentIndex4.value + 1) % images4.value.length;
};

const prevImage4 = () => {
  currentIndex4.value =
    (currentIndex4.value - 1 + images4.value.length) % images4.value.length;
};

const goToImage4 = (index) => {
  currentIndex4.value = index;
};
</script>
            ...
            <div class="definition-card" style="border-left-color: #e67e22">
              ...
              <div class="lineation-types">
                ...
                <div class="type" style="border-left-color: #16a085">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/03劈理和线理/交面线理.jpg"
                      alt="交面线理"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">交面线理</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section class="section">
          ...
          <div v-if="expandedSections.folds" class="section-content">
            <div class="geo-carousel">
              ...
              <!-- 图片标题 -->
              <div class="geo-carousel-caption">
                <h3>{{ currentImage2.title }}</h3>
                <p>{{ currentImage2.description }}</p>
              </div>

              <!-- 导航按钮 -->
              <div class="geo-carousel-nav">
                <button class="geo-carousel-btn" @click="prevImage2">‹</button>
                <button class="geo-carousel-btn" @click="nextImage2">›</button>
              </div>
            ...
            <div class="fold-types-card" style="border-left-color: #8e44ad">
              ...
              <div class="fold-types">
                <div class="type" style="border-left-color: #e74c3c">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/04褶皱/背斜.jpg"
                      alt="背斜"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">背斜</div>
                  </div>
                </div>
                ...
                <div class="type" style="border-left-color: #3498db">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/04褶皱/向斜.jpg"
                      alt="向斜"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">向斜</div>
                  </div>
                </div>
              </div>
      ...
      <div v-if="activeTab === 'extension'" class="extension-content">
        <section class="section">
          ...
          <div v-if="expandedSections.extensionTypes" class="section-content">
            <div class="geo-image-container">
              <img
                src="@/assets/StructureField/05伸展构造/伸展构造（裂谷）.jpg"
                alt="伸展构造（裂谷）"
                class="geo-image geo-image-small"
              />
              <div class="geo-image-caption">伸展构造（裂谷）</div>
            </div>
            <p class="geo-text">
            ...
            <div class="geo-definition-card" style="border-left-color: #8e44ad">
              ...
              <div class="geo-example">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/05伸展构造/大规模地堑发育.jpg"
                    alt="大规模地堑发育"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">大规模地堑发育</div>
                </div>
              </div>
              ...
              <div class="geo-image-container">
                <img
                  src="@/assets/StructureField/05伸展构造/美国盆岭区.jpg"
                  alt="美国盆岭区"
                  class="geo-image geo-image-small"
                />
                <div class="geo-image-caption">美国盆岭区</div>
              </div>
              ...
              <div class="geo-example">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/05伸展构造/松辽盆地.jpg"
                    alt="松辽盆地"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">松辽盆地</div>
                </div>
              </div>
              ...
              <div class="geo-example">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/05伸展构造/红海裂谷.jpg"
                    alt="红海裂谷"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">红海裂谷</div>
                </div>
              </div>
              ...
              <div class="geo-example">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/05伸展构造/变质核杂岩的形成1.jpg"
                    alt="变质核杂岩的形成"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">变质核杂岩的形成</div>
                </div>
              </div>
              ...
              <div class="geo-example">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/05伸展构造/岩墙群1.jpg"
                    alt="岩墙群"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">岩墙群</div>
                </div>
              </div>
        ...
        <section class="section">
          ...
          >
            ...
            <div class="geo-image-container">
              <img
                src="@/assets/StructureField/05伸展构造/伸展构造的发育规律及动力学过程.jpg"
                alt="伸展构造的发育规律及动力学过程"
                class="geo-image geo-image-small"
              />
              <div class="geo-image-caption">
            ...
            <div class="definition-card" style="border-left-color: #9b59b6">
              ...
              <div class="geo-paragraph-group highlight">
                ...
                <p class="geo-paragraph">
                  地壳浅层次以各种<span class="geo-term">正断层</span>及<span
                    class="geo-term"
                    >低缓角度拆离带</span
          ...
          >
            <div class="definition-card" style="border-left-color: #3498db">
              ...
              <div class="geo-paragraph-group">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/05伸展构造/构造反转1.jpg"
                    alt="构造反转"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">构造反转</div>
                </div>
              </div>
              ...
              <div class="geo-paragraph-group highlight">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/05伸展构造/伸展和挤压两种作用和两类构造对比表.jpg"
                    alt="伸展和挤压两种作用和两类构造对比表"
                    class="geo-image geo-image-middle"
                  />
                  <div class="geo-image-caption">
                    伸展和挤压两种作用和两类构造对比表
      ...
      <div v-if="activeTab === 'shear'" class="shear-content">
        <section class="section">
          ...
          <div v-if="expandedSections.shearTypes" class="section-content">
            <div class="geo-image-container">
              <img
                src="@/assets/StructureField/06剪切带/剪切带.jpg"
                alt="剪切带"
                class="geo-image geo-image-small"
              />
              <div class="geo-image-caption">剪切带</div>
            </div>
            <p class="geo-text">
            ...
            <div class="fold-types-card" style="border-left-color: #e74c3c">
              ...
              <div class="fold-types">
                <div class="type" style="border-left-color: #e74c3c">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/06剪切带/脆性剪切带.jpg"
                      alt="脆性剪切带"
                      class="geo-image geo-image-small"
                    />
                    <div class="geo-image-caption">脆性剪切带</div>
                  </div>
                </div>
                <div class="type" style="border-left-color: #f39c12">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/06剪切带/脆-韧性剪切带.jpg"
                      alt="脆-韧性剪切带"
                      class="geo-image geo-image-small"
                    />
                    <div class="geo-image-caption">脆-韧性剪切带</div>
                  </div>
                </div>
                <div class="type" style="border-left-color: #3498db">
                  <h4>韧性剪切带</h4>
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/06剪切带/韧性剪切带图示.jpg"
                      alt="韧性剪切带"
                      class="geo-image geo-image-small"
                    />
                    <div class="geo-image-caption">韧性剪切带</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="expandedSections.ductileShear" class="section-content">
            <div class="definition-card" style="border-left-color: #3498db">
              ...
              <div class="geo-paragraph-group">
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/06剪切带/韧性剪切带2.jpg"
                    alt="韧性剪切带"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">韧性剪切带</div>
              ...
              <div class="geo-paragraph-group highlight">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/06剪切带/糜棱岩.jpg"
                    alt="糜棱岩"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">糜棱岩</div>
                </div>
                <p class="geo-paragraph">
              ...
              <div class="geo-paragraph-group highlight">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/06剪切带/褶皱变形.jpg"
                    alt="褶皱变形"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">褶皱变形</div>
                </div>
                <p class="geo-paragraph">
              ...
              <div class="geo-paragraph-group highlight">
                ...
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/06剪切带/变质作用带.jpg"
                    alt="变质作用带"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">变质作用带</div>
                </div>
                <p class="geo-paragraph">
              ...
              <div class="geo-method-list">
                <div class="geo-method-item">
                  ...
                  <div class="geo-method-content">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/06剪切带/韧性剪切带的剪切运动.jpg"
                        alt="韧性剪切带的剪切运动"
                        class="geo-image geo-image-small"
                      />
                      <div class="geo-image-caption">韧性剪切带的剪切运动</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="geo-method-item">
                  ...
                  <div class="geo-method-content">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/06剪切带/鞘褶皱.jpg"
                        alt="鞘褶皱"
                        class="geo-image geo-image-small"
                      />
                      <div class="geo-image-caption">鞘褶皱</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="geo-method-item">
                  ...
                  <div class="geo-method-content">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/06剪切带/S-C构造1.jpg"
                        alt="S-C构造"
                        class="geo-image geo-image-small"
                      />
                      <div class="geo-image-caption">S-C构造</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="geo-method-item">
                  ...
                  <div class="geo-method-content">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/06剪切带/云母鱼构造.jpg"
                        alt="云母鱼构造"
                        class="geo-image geo-image-small"
                      />
                      <div class="geo-image-caption">云母鱼构造</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="geo-method-item">
                  ...
                  <div class="geo-method-content">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/06剪切带/“多米诺骨牌”构造.jpg"
                        alt="“多米诺骨牌”构造"
                        class="geo-image geo-image-small"
                      />
                      <div class="geo-image-caption">“多米诺骨牌”构造</div>
                    </div>
                  </div>
                </div>
                ...
                <div class="geo-method-item">
                  ...
                  <div class="geo-method-content">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/06剪切带/糜棱岩捕虏体.jpg"
                        alt="糜棱岩捕虏体"
                        class="geo-image geo-image-small"
                      />
                      <div class="geo-image-caption">糜棱岩捕虏体</div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section class="section">
          ...
          <div v-if="expandedSections.mountain" class="section-content">
            <div class="geo-carousel">
              <!-- 当前显示的图片 -->
              <img
                :src="currentImage4.src"
                :alt="currentImage4.alt"
                class="geo-carousel-image"
              />

              <!-- 图片标题 -->
              <div class="geo-carousel-caption">
                <h3>{{ currentImage4.title }}</h3>
                <p>{{ currentImage4.description }}</p>
              </div>

              <!-- 导航按钮 -->
              <div class="geo-carousel-nav">
                <button class="geo-carousel-btn" @click="prevImage4">‹</button>
                <button class="geo-carousel-btn" @click="nextImage4">›</button>
              </div>
            ...
            <div class="geo-concept-card fold-mountain">
              ...
              <div class="geo-image-container">
                <img
                  src="@/assets/StructureField/07山脉形成/褶皱山.jpg"
                  alt="褶皱山"
                  class="geo-image geo-image-small"
                />
                <div class="geo-image-caption">褶皱山</div>
              </div>
              <p>
              ...
              <div class="geo-subtypes">
                <div class="geo-subtype anticline">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/背斜山.jpg"
                      alt="背斜山"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">背斜山</div>
                  </div>
                </div>
                ...
                <div class="geo-subtype syncline">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/向斜山.jpg"
                      alt="向斜山"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">向斜山</div>
                  </div>
                </div>
                ...
                <div class="geo-subtype monocline">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/单面山.jpg"
                      alt="单面山"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">单面山</div>
                  </div>
                </div>
              </div>
            ...
            <div class="geo-concept-card fault-mountain">
              ...
              <div class="geo-image-container">
                <img
                  src="@/assets/StructureField/07山脉形成/断块山.jpg"
                  alt="断块山"
                  class="geo-image geo-image-small"
                />
                <div class="geo-image-caption">断块山</div>
              </div>
              <p>
              ...
              <div class="geo-subtypes">
                <div class="geo-subtype horst">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/地垒式断块山.jpg"
                      alt="地垒式断块山"
                      class="geo-image geo-image-small"
                    />
                    <div class="geo-image-caption">地垒式断块山</div>
                  </div>
                </div>
                ...
                <div class="geo-subtype tilted">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/掀斜式断块山.jpg"
                      alt="掀斜式断块山"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">掀斜式断块山</div>
                  </div>
                </div>
              </div>
            ...
            <div class="geo-concept-card volcano-mountain">
              ...
              <div class="geo-image-container">
                <img
                  src="@/assets/StructureField/07山脉形成/火山.jpg"
                  alt="火山"
                  class="geo-image geo-image-small"
                />
                <div class="geo-image-caption">火山</div>
              </div>
              <p>
              ...
              <div class="geo-subtypes">
                <div class="geo-subtype active-volcano">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/爪哇岛梅拉皮火山.jpg"
                      alt="爪哇岛梅拉皮火山"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">爪哇岛梅拉皮火山</div>
                  </div>
                </div>
                ...
                <div class="geo-subtype extinct-volcano">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/乞力马扎罗山.jpg"
                      alt="乞力马扎罗山"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">乞力马扎罗山</div>
                  </div>
                </div>
                ...
                <div class="geo-subtype dormant-volcano">
                  ...
                  <div class="geo-image-container">
                    <img
                      src="@/assets/StructureField/07山脉形成/长白山天池.jpg"
                      alt="长白山天池"
                      class="geo-image geo-image-middle"
                    />
                    <div class="geo-image-caption">长白山天池</div>
                  </div>
                </div>
              </div>
            ...
            <div class="geo-concept-card dome-mountain">
              ...
              <div class="geo-image-container">
                <img
                  src="@/assets/StructureField/07山脉形成/冠状山.jpg"
                  alt="冠状山"
                  class="geo-image geo-image-small"
                />
                <div class="geo-image-caption">冠状山</div>
              </div>
              <p>
        ...
        <section class="section">
          ...
          <div v-if="expandedSections.plate" class="section-content">
            ...
            <div class="plate-intro-box">
              <div class="geo-image-container">
                <img
                  src="@/assets/StructureField/08板块构造/地球板块运动.jpg"
                  alt="地球板块运动"
                  class="geo-image geo-image-small"
                />
                <div class="geo-image-caption">地球板块运动</div>
              </div>
              <p class="plate-intro">
            ...
            <div class="plate-concept-card">
              ...
              <div class="plate-concept-content">
                <div class="geo-image-container">
                  <img
                    src="@/assets/StructureField/08板块构造/地球划分.jpg"
                    alt="地球划分"
                    class="geo-image geo-image-small"
                  />
                  <div class="geo-image-caption">地球划分</div>
                </div>
                <p>
              ...
              <div class="plate-concept-content">
                ...
                <div class="plate-subtypes">
                  <div class="plate-subtype friction-subtype">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/08板块构造/基础阻力.jpg"
                        alt="基础阻力(摩擦力)"
                        class="geo-image geo-image-middle"
                      />
                      <div class="geo-image-caption">基础阻力(摩擦力)</div>
                    </div>
                  </div>
                  ...
                  <div class="plate-subtype gravity-subtype">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/08板块构造/板块吸力.jpg"
                        alt="板块吸力(重力)"
                        class="geo-image geo-image-middle"
                      />
                      <div class="geo-image-caption">板块吸力(重力)</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="plate-concept-content">
                ...
                <div class="plate-subtypes">
                  <div class="plate-subtype divergent-subtype">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/08板块构造/东非大裂谷.jpg"
                        alt="离散型边界（东非大裂谷）"
                        class="geo-image geo-image-middle"
                      />
                      <div class="geo-image-caption">离散型边界（东非大裂谷）</div>
                    </div>
                  </div>
                  ...
                  <div class="plate-subtype convergent-subtype">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/08板块构造/汇聚型边界（喜马拉雅山脉）.jpg"
                        alt="汇聚型边界（喜马拉雅山脉）"
                        class="geo-image geo-image-middle"
                      />
                      <div class="geo-image-caption">汇聚型边界（喜马拉雅山脉）</div>
                    </div>
                  </div>
                  ...
                  <div class="plate-subtype transform-subtype">
                    ...
                    <div class="geo-image-container">
                      <img
                        src="@/assets/StructureField/08板块构造/守恒型边界（圣安德烈亚斯断层）.jpg"
                        alt="守恒型边界（圣安德烈亚斯断层）"
                        class="geo-image geo-image-middle"
                      />
                      <div class="geo-image-caption">守恒型边界（圣安德烈亚斯断层）</div>
                    </div>
                  </div>
                </div>
              </div>

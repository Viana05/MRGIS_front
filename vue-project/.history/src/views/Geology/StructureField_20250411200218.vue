  ...
  <div class="geology-observation-system">
    ...
    <main class="content">
      ...
      <div v-if="activeTab === 'extension'" class="extension-content">
        ...
        <section class="geo-section" id="extensionDevelopment">
          <div
            class="geo-section-header"
            :class="{ active: expandedSections.extensionDevelopment }"
            @click="toggleSection('extensionDevelopment')"
          >
            <h2>发育规律及动力学过程</h2>
            <span class="geo-toggle-icon">
              {{ expandedSections.extensionDevelopment ? "−" : "+" }}
            </span>
          </div>
          <div
            class="geo-section-content"
            :class="{ expanded: expandedSections.extensionDevelopment }"
          >

    ...
    <div class="stratigraphy-container">
      ...
      >
        ...
        <div class="geo-section-content">
          ...
          <div class="geo-facies-type">
                <h4 class="geo-facies-title">
                    <i class="fas fa-snowflake geo-facies-icon"></i>
                    冰川相（glacial facies）
                </h4>
                <div class="geo-facies-content">
                    <p>是陆相沉积类型之一，是由冰川作用堆积形成的沉积物，形成于年平均温度很低的地区。</p>
                    <div class="geo-classification-box">
                        <h5>细分类型：</h5>
                        <ul class="geo-feature-list">
                            <li>冰碛相</li>
            ...
            <div class="geo-facies-type">
                <h4 class="geo-facies-title">
                    <i class="fas fa-fan geo-facies-icon"></i>
                    冲积扇
                </h4>
                <div class="geo-facies-content">
                    <p>是山地河流出口处的堆积地貌。山地河流流过山麓后，因坡度变缓，流速降低，河道变宽，河水携带的砂石大量堆积，使河床抬高，因此河流不断变迁改道，或分成多股水流，形成一个延伸很广，坡度较缓的台地，外形如同折扇。</p>
                    <div class="geo-classification-box">
                        <h5>冲积扇相划分：</h5>
                        <ul class="geo-feature-list">
                            <li>扇根(顶)</li>
                        ...
                        <p>它们之间没有明显的界线。此外，在扇与扇之间，还存在着扇间地带。</p>
                    </div>
                </div>
            </div>
            ...
            <div class="geo-facies-type">
                <h4 class="geo-facies-title">
                    <i class="fas fa-water geo-facies-icon"></i>
                    河流相（fluvial facies）
                </h4>
                <div class="geo-facies-content">
                    <p>属陆相沉积类型。是由河流或其它径流作用形成的一套沉积物或沉积岩。</p>
                    <div class="geo-classification-box">
                        <h5>亚相类型：</h5>
                        <ul class="geo-type-list">
                            <li>谷底滞流沉积</li>
                    ...
                    <div class="geo-characteristic-box">
                        ...
                        <ul class="geo-feature-list">
                            ...
                            <li>粒度分布多双峰态</li>
                            <li>粒度概率图显两段式</li>
                            <li>层理类型多样，以反映单向水流的大型槽状和板状交错层理为特征</li>
                            <li>波痕不对称</li>
                            <li>可见砾石呈迭瓦状排列</li>
                            <li>具明显的间断正韵律</li>
                            <li>砂体呈透镜状</li>
            ...
            <div class="geo-facies-type">
                <h4 class="geo-facies-title">
                    <i class="fas fa-lake geo-facies-icon"></i>
            ...
            <div class="geo-facies-type">
                <h4 class="geo-facies-title">
                    <i class="fas fa-tree geo-facies-icon"></i>
                    沼泽相（swamp facies）
                </h4>
                <div class="geo-facies-content">
                    <p>是在沼泽环境形成的沉积物。地质历史中沼泽发育的主要时代是石炭纪、侏罗纪等。</p>
                    <p>当时气候温暖潮湿，沼泽中植物丛生，有大量的泥炭堆积。泥炭埋藏在地下，经煤化作用转变为煤，所以煤成为古代沼泽相的主要成分。</p>
                </div>
            </div>
        </div>
        ...
        <div class="geo-subsection">
            ...
            <div class="geo-facies-type">
                <h4 class="geo-facies-title">
                    <i class="fas fa-delta geo-facies-icon"></i>
                    三角洲相（delta facies）
                </h4>
                <div class="geo-facies-content">
                    <p>是海陆过渡相组的重要组成部分，指河流与海盆(或与湖泊)的汇合处形成的大型锥状沉积物堆积体。</p>
                    <p>在河流入海(或入湖)盆地的河口区，因坡度减缓，水流扩散，流速降低，遂将携带的泥沙沉积于此，形成近于顶尖向陆的三角形沉积体，规模可自数平方千米到几千平方千米。</p>
                    <div class="geo-classification-box">
            ...
            <div class="geo-facies-type">
                ...
                <div class="geo-facies-content">
                    <p>属于海陆过渡相组。在构造沉降幅度大的海岸地区，一般都为潮汐作用很强的高潮差区，在此类海岸的河口地区，受潮汐和河流两个因素的作用。</p>
                    <p>当河流泥沙供应不足时并不形成三角洲，而是形成喇叭形的河口湾（estuary），又因其形似三角形故又叫三角港。主要由上三角洲平原(无潮汐作用)、下三角洲平原(潮间泥坪)、分流河道、潮道、潮汐沙坝等组成。</p>
                </div>
            </div>
        </div>
        ...
        <div class="geo-subsection">
            ...
            <div class="geo-facies-type">
                <h4 class="geo-facies-title">
                    <i class="fas fa-umbrella-beach geo-facies-icon"></i>
                    滨岸相（Shore facies）
                </h4>
                <div class="geo-facies-content">
                    <p>又称海岸相，是海相的亚相之一。滨岸指海水波浪基准面之上，紧邻陆地的滨浅海地带，包括潮上带、潮间带和潮下带。</p>
                    <p>这一地带的水动力条件、水化学状况及海洋地貌均较复杂。主要由于波浪作用和潮汐作用，形成海岸相的各种沉积体，其中重要的有海滩、堤岛、泻湖、潮坪等沉积类型。</p>
                    <div class="geo-classification-box">
                        <h5>海岸类型划分：</h5>
                        <ul class="geo-feature-list">
                            <li>无障壁海岸</li>
                        ...
                        <p>根据沉积物的性质又可进一步分为陆源碎屑沉积海岸及碳酸盐沉积海岸。</p>
                    </div>
                </div>
            </div>
            ...
            <div class="geo-facies-type">
                ...
                <div class="geo-facies-content">
                    <p>与滨岸相相邻，即从近滨的外侧至大陆坡内侧的广阔陆棚区，宽度由数公里至百公里。</p>
                    <p>古代浅海陆棚相是长期地质发展的沉积产物，沉积厚度大，分布面积广。浅海陆棚相可划分为过渡带及滨外陆棚两个亚相，但有时难以分出过渡带。</p>
                    <p>古代滨外陆棚主要为粘土—粉砂沉积，砂砾较小，常有大量化学岩及生物化学岩，如碳酸盐岩及部分铁、锰、铝、磷沉积岩等。</p>
                </div>
            </div>
            ...
            <div class="geo-facies-type">
                ...
                <div class="geo-facies-content">
                    <p>形成于大陆坡（continental slope），海水深度200～2000米或3000米，指大陆斜坡环境中沉积物质的总特征。</p>
                    <p>半深海相的沉积物中泥质沉积占多数。从沉积作用的机理上看，半深海相的碎屑沉积主要是重力流成因，在沉积层序中保留着由重力流沉积作用而造成的结构、构造特征。</p>
                    <p>大陆坡上常发育有海底峡谷，它是重力流沉积物进入洋底的通道，在峡谷中及其附近可发育滑塌沉积及泥石流沉积。</p>
                </div>
            </div>
            ...
            <div class="geo-facies-type">
                ...
                <div class="geo-facies-content">
                    <p>是海相沉积类型之一。形成于大洋底部，海水深度>2000--3000米。海深相中的主要沉积物是含抱球虫的石灰质软泥、含硅藻和放射虫的硅质软泥、红色软泥等。</p>
                    <p>近年来由于海洋地质学的迅速发展，逐渐揭开了深海沉积的秘密。许多资料证实，由于浊流沉积作用，在深海中沉积有厚度大面积广的浊积岩。</p>
                </div>
            </div>
        </div>
      </div>
...
.geo-classification-box,
.geo-characteristic-box {
...
.geo-classification-box h5,
.geo-characteristic-box h5 {
  color: #5d4037;
  margin-top: 0;
  margin-bottom: 10px;
}

...
// 形成过程折叠控制
const formationActiveNames = ref([]);
const riverActiveNames = ref([]);
const faciesActiveNames = ref([]);
const fanActiveNames = ref([]);
const fanFaciesActiveNames = ref([]);
const fanModelActiveNames = ref([]);
...
<template>
  <div class="main-content">
      ...
      <ul class="nav-list">
        ...
        <li>
          <a
            href="#delta-section"
            class="nav-link"
            :class="{ active: activeNav === 'delta-section' }"
            @click="(e) => handleNavClick(e, 'delta-section')"
          >
            08 三角洲相
          </a>
        </li>
    ...
    <div class="stratigraphy-container">
      ...
      <!-- 08三角洲相 -->
      <div class="delta-facies-container">
        <div class="demo-collapse">
          <el-collapse v-model="activeNames" accordion class="rock-collapse">
            ...
            <el-collapse-item
              title="08 三角洲相"
              name="8"
              class="collapse-item delta-section"
            >
              <div class="rock-content">
                ...
                <!-- 形成过程 -->
                <div v-show="activeTab === 'formation'" class="content-section">
                  <h2 class="section-title">（1）形成</h2>
                  <div class="content-card">
                    ...
                    <div class="definition-box">
                      <h3>此定义主要包括了如下四个方面的含义：</h3>
                      <ol>
                        <li>三角洲沉积物来源于一个或几个可确定的点物源；</li>
                        <li>三角洲以进积结构为特征；</li>
                        <li>
                          管三角洲能最终充填盆地，但它们都发育于盆地周缘；
                        </li>
                        <li>
                ...
                <!-- 河流、波浪、潮汐 -->
                <div v-show="activeTab === 'types'" class="content-section">
                  <h2 class="section-title">（2）河流、波浪、潮汐</h2>

                  <div class="type-selector">
                    <el-radio-group v-model="activeDeltaType">
                      <el-radio-button
                  ...
                  >
                    <h3>河控三角洲（river-dominated delta）</h3>
                    <p>
                      是在河流输入泥沙量大，波浪、潮汐作用较弱，河流建设作用远超波浪和潮沙破坏作用的条件下形成的。
                    </p>

                    <div class="subtype-selector">
                      <el-radio-group v-model="activeRiverSubtype">
                        <el-radio-button
                    ...
                    <el-collapse
                      v-model="riverActiveNames"
                      class="subtype-collapse"
                    >
                      <el-collapse-item
                        title="长形（鸟足状）三角洲"
                        name="elongate"
                      >
                        <p>
                          是以河流作用为主的极端类型，是最典型的高建设性三角洲。
                        </p>
                      </el-collapse-item>

                      <el-collapse-item title="朵叶状三角洲" name="lobate">
                        <p>
                    ...
                    <div class="facies-section">
                      <h4>三角洲相亚相划分：</h4>
                      <el-collapse
                        v-model="faciesActiveNames"
                        class="facies-collapse"
                      >
                        <el-collapse-item title="三角洲平原亚相" name="plain">
                          <p>
                        ...
                        <el-collapse-item title="三角洲前缘亚相" name="front">
                          <p>
                            围绕三角洲平原的边缘伸向海洋或湖，位于海平面以下。为河流和海水的剧烈交锋带，沉积作用活跃，是三角洲砂体的主体。
                          </p>
                        </el-collapse-item>

                        <el-collapse-item title="前三角洲亚相" name="prodelta">
                          <p>
                  ...
                  <!-- 浪控三角洲 -->
                  <div
                    v-show="activeDeltaType === 'wave'"
                    class="delta-type-content"
                  >
                    <h3>浪控三角洲（wave-dominated delta）</h3>
                    <p>
                  ...
                  <!-- 潮控三角洲 -->
                  <div
                    v-show="activeDeltaType === 'tide'"
                    class="delta-type-content"
                  >
                    <h3>潮控三角洲（tide-dominated delta）</h3>
                    <p>
                ...
                <!-- 扇三角洲 -->
                <div v-show="activeTab === 'fan'" class="content-section">
                  <h2 class="section-title">（3）扇三角洲</h2>
                  <div class="content-card">
                    <p>
                    ...
                    <div class="fan-type-selector">
                      <el-radio-group v-model="activeFanType">
                        <el-radio-button
                    ...
                    <el-collapse v-model="fanActiveNames" class="fan-collapse">
                      <el-collapse-item title="湖泊扇三角洲" name="lake">
                        <p>中国东部断陷湖盆中常发育规模不等的湖泊扇三角洲。</p>
                      </el-collapse-item>

                      <el-collapse-item title="波浪改造的扇三角洲" name="wave">
                        <p>受波浪作用改造的扇三角洲类型。</p>
                      </el-collapse-item>

                      <el-collapse-item title="潮汐改造的扇三角洲" name="tide">
                        <p>受潮汐作用改造的扇三角洲类型。</p>
                      </el-collapse-item>
                    </el-collapse>
                    ...
                    <div class="fan-facies-section">
                      <h3>扇三角洲亚相划分：</h3>
                      <el-collapse
                        v-model="fanFaciesActiveNames"
                        class="fan-facies-collapse"
                      >
                        <el-collapse-item title="扇三角洲平原" name="plain">
                          <p>
                            是扇三角洲的陆上部分，其范围包括从扇端至岸线之间的近海平原地带。以水流和重力流的粗粒沉积物为特征，砂砾层具不明显的平行层理或交错层理，分选差。
                          </p>
                        </el-collapse-item>

                        <el-collapse-item title="扇三角洲前缘" name="front">
                          <p>
                            亦称过渡带，位于岸线至正常天气浪基面之间的浅水区。以较陡的前积相为特征，牵引流为主，常见大、中型交错层理。
                          </p>
                        </el-collapse-item>

                        <el-collapse-item title="前扇三角洲" name="prodelta">
                          <p>
                    ...
                    <div class="fan-model-section">
                      <h3>扇三角洲沉积模式：</h3>
                      <el-collapse
                        v-model="fanModelActiveNames"
                        class="fan-model-collapse"
                      >
                        <el-collapse-item title="斜坡型模式" name="slope">
                          <p>
                            主要是根据牙买加东南部耶拉斯扇三角洲的沉积特点建立的。该模式可适用于进积到岛坡、陆坡或断陷盆地边缘的扇三角洲。
                          </p>
                        </el-collapse-item>

                        <el-collapse-item title="陆棚型模式" name="shelf">
                          <p>
                            发育在坡度低缓而宽阔的陆棚海边缘，又称缓坡型扇三角洲。陆棚型扇三角洲模式是根据阿拉斯加东南海岸，以科珀河扇三角洲为代表的一些扇三角洲的沉积特点建立的。
                          </p>
                        </el-collapse-item>

                        <el-collapse-item title="吉伯特型模式" name="gilbert">
                          <p>
                            最早被吉尔伯特研究的美国邦维尔湖(Lake
                            Bonneville)的三角洲实际上是个典型的湖泊扇三角洲。该扇三角洲以具有顶积层、前积层和底积层"三褶构造"为特征。
                          </p>
                        </el-collapse-item>
                      </el-collapse>
                    </div>
...
.delta-section :deep(.el-collapse-item__header) {

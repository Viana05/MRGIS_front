    ...
    <div class="stratigraphy-container">
      ...
      <div class="content-section sedimentary-facies" id="sedimentary-facies">
        ...
        <div class="section-content">
          ...
          <!-- 定义部分 -->
          <div
            v-show="activeCategory === 'definition'"
          ...
          <!-- 陆相组 -->
          <div
            v-show="activeCategory === 'continental'"
            class="continental-section"
          >
            <h3 class="subsection-title">（2）陆相组</h3>

            <!-- 残积相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('eluvial')">
                <span class="toggle-icon">{{
                  collapsed.eluvial ? "+" : "-"
                }}</span>
                残积相（eluvial facies）
              </h4>
              <div v-show="!collapsed.eluvial">
                <p>
            ...
            <!-- 坡积相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('slope')">
                <span class="toggle-icon">{{
                  collapsed.slope ? "+" : "-"
                }}</span>
                坡积相（slope wash facies）
              </h4>
              <div v-show="!collapsed.slope">
                <p>
                  是高地基岩的风化产物，由于雨雪等的作用，借助于重力沿斜坡滚动，堆积在山坡上形成的沉积物。
                </p>
                <p>
            ...
            <!-- 沙漠相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('desert')">
                <span class="toggle-icon">{{
                  collapsed.desert ? "+" : "-"
                }}</span>
                沙漠相（desert facies）
              </h4>
              <div v-show="!collapsed.desert">
            ...
            <!-- 冰川相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('glacial')">
                <span class="toggle-icon">{{
                  collapsed.glacial ? "+" : "-"
                }}</span>
                冰川相（glacial facies）
              </h4>
              <div v-show="!collapsed.glacial">
                <p>
            ...
            <!-- 冲积扇 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('alluvial')">
                <span class="toggle-icon">{{
                  collapsed.alluvial ? "+" : "-"
                }}</span>
                冲积扇
              </h4>
              <div v-show="!collapsed.alluvial">
                <p>
            ...
            <!-- 河流相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('fluvial')">
                <span class="toggle-icon">{{
                  collapsed.fluvial ? "+" : "-"
                }}</span>
                河流相（fluvial facies）
              </h4>
              <div v-show="!collapsed.fluvial">
                <p>
                ...
                <div class="feature-box">
                  ...
                  <ul>
                    <li>
                      岩石由砾砂、粉砂、粘土等碎屑沉积物组成，成分成熟度低，常见底部冲刷面，其上有泥砾
                    </li>
                    <li>
                      分选性差到中等，粒度分布多双峰态，粒度概率图显两段式
                    </li>
                    <li>
                      层理类型多样，以反映单向水流的大型槽状和板状交错层理为特征，波痕不对称，可见砾石呈迭瓦状排列
                    </li>
                    <li>
            ...
            <!-- 湖泊相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('lacustrine')">
                <span class="toggle-icon">{{
                  collapsed.lacustrine ? "+" : "-"
                }}</span>
                湖泊相（lacustrine facies）
              </h4>
              <div v-show="!collapsed.lacustrine">
            ...
            <!-- 沼泽相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('swamp')">
                <span class="toggle-icon">{{
                  collapsed.swamp ? "+" : "-"
                }}</span>
                沼泽相（swamp facies）
              </h4>
              <div v-show="!collapsed.swamp">
                <p>
          ...
          <!-- 过渡相组 -->
          <div
            v-show="activeCategory === 'transitional'"
            class="transitional-section"
          >
            <h3 class="subsection-title">（3）过渡相组</h3>

            <!-- 三角洲相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('delta')">
                <span class="toggle-icon">{{
                  collapsed.delta ? "+" : "-"
                }}</span>
                三角洲相（delta facies）
              </h4>
              <div v-show="!collapsed.delta">
                <p>
            ...
            <!-- 河口湾相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('estuary')">
                <span class="toggle-icon">{{
                  collapsed.estuary ? "+" : "-"
                }}</span>
                河口湾相
              </h4>
              <div v-show="!collapsed.estuary">
                <p>
          ...
          <!-- 海相组 -->
          <div v-show="activeCategory === 'marine'" class="marine-section">
            <h3 class="subsection-title">（4）海相组</h3>

            <!-- 滨岸相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('shore')">
                <span class="toggle-icon">{{
                  collapsed.shore ? "+" : "-"
                }}</span>
                滨岸相（Shore facies）
              </h4>
              <div v-show="!collapsed.shore">
                <p>
            ...
            <!-- 浅海陆棚相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('shelf')">
                <span class="toggle-icon">{{
                  collapsed.shelf ? "+" : "-"
                }}</span>
                浅海陆棚相（shallow sea shelf facies）
              </h4>
              <div v-show="!collapsed.shelf">
                <p>
            ...
            <!-- 半深海相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('bathyal')">
                <span class="toggle-icon">{{
                  collapsed.bathyal ? "+" : "-"
                }}</span>
                半深海相（bathyal facies）
              </h4>
              <div v-show="!collapsed.bathyal">
                <p>
                  形成于大陆坡（continental
            ...
            <!-- 深海相 -->
            <div class="facies-type">
              <h4 class="facies-title" @click="toggleCollapse('abyssal')">
                <span class="toggle-icon">{{
                  collapsed.abyssal ? "+" : "-"
                }}</span>
                深海相（abyssal facies）
              </h4>
              <div v-show="!collapsed.abyssal">
                <p>

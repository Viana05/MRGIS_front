...
const rippleImages = {
  current: [
    { image: "current_ripple1.jpg", caption: "流水波痕表面特征" },
    { image: "current_ripple2.jpg", caption: "流水波痕剖面结构" },
  ],
  wave: [
    { image: "wave_ripple1.jpg", caption: "浪成波痕表面特征" },
    { image: "wave_ripple2.jpg", caption: "浪成波痕剖面结构" },
  ],
  wind: [
    { image: "wind_ripple1.jpg", caption: "风成波痕表面特征" },
    { image: "wind_ripple2.jpg", caption: "风成波痕剖面结构" },
  ],
};

const beddingImages = {
  graded: [
    { image: "graded_bedding1.jpg", caption: "递变层理宏观特征" },
    { image: "graded_bedding2.jpg", caption: "递变层理微观结构" },
  ],
  horizontal: [
    { image: "horizontal_bedding1.jpg", caption: "水平层理野外露头" },
    { image: "horizontal_bedding2.jpg", caption: "水平层理薄片观察" },
  ],
  cross: [
    { image: "cross_bedding1.jpg", caption: "交错层理三维特征" },
    { image: "cross_bedding2.jpg", caption: "交错层理剖面结构" },
  ],
  parallel: [
    { image: "parallel_bedding1.jpg", caption: "平行层理宏观特征" },
    { image: "parallel_bedding2.jpg", caption: "平行层理微观结构" },
  ],
};

const erosionImages = {
  scour: [
    { image: "scour_mark1.jpg", caption: "槽痕冲刷构造" },
    { image: "scour_mark2.jpg", caption: "纵向脊与沟构造" },
  ],
  tool: [
    { image: "tool_mark1.jpg", caption: "沟痕压刻构造" },
    { image: "tool_mark2.jpg", caption: "V形压刻痕迹" },
  ],
  rill: [
    { image: "rill_mark1.jpg", caption: "细流痕表面特征" },
    { image: "rill_mark2.jpg", caption: "细流痕剖面结构" },
  ],
};

const deformationImages = [
  { image: "flame_structure.jpg", caption: "火焰状构造" },
  { image: "convolute_bedding.jpg", caption: "包卷层理" },
  { image: "mud_crack.jpg", caption: "干裂构造" },
  { image: "rain_impression.jpg", caption: "雨痕构造" },
];

const chemicalImages = {
  crystal: [
    { image: "crystal_impression1.jpg", caption: "盐类晶体印痕" },
    { image: "crystal_impression2.jpg", caption: "冰晶假象" },
  ],
  birdseye: [
    { image: "birdseye1.jpg", caption: "鸟眼构造宏观特征" },
    { image: "birdseye2.jpg", caption: "鸟眼构造微观结构" },
  ],
  concretion: [
    { image: "concretion1.jpg", caption: "碳酸盐质结核" },
    { image: "concretion2.jpg", caption: "铁质结核" },
  ],
  stylolite: [
    { image: "stylolite1.jpg", caption: "简单波曲形缝合线" },
    { image: "stylolite2.jpg", caption: "复杂弯曲形缝合线" },
  ],
};

const biologicalImages = {
  stromatolite: [
    { image: "stromatolite1.jpg", caption: "柱状叠层石" },
    { image: "stromatolite2.jpg", caption: "锥状叠层石" },
  ],
  tracefossil: [
    { image: "trace_fossil1.jpg", caption: "生物潜穴构造" },
    { image: "trace_fossil2.jpg", caption: "生物足迹化石" },
  ],
};
      ...
      >
        ...
        <div class="section-content">
          ...
          >
              ...
              <div v-show="!collapsed.ripple">
                ...
                <div v-show="activeRippleType === 'current'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in rippleImages.current"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
                        :alt="item.caption"
                        @click="openLightbox(item.image, item.caption)"
                      />
                ...
                <div v-show="activeRippleType === 'wave'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in rippleImages.wave"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
                ...
                <div v-show="activeRippleType === 'wind'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in rippleImages.wind"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
              ...
              <div v-show="!collapsed.bedding">
                ...
                <div v-show="activeBeddingType === 'graded'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in beddingImages.graded"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
                ...
                >
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in beddingImages.horizontal"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
                ...
                <div v-show="activeBeddingType === 'cross'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in beddingImages.cross"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
                ...
                <div v-show="activeBeddingType === 'parallel'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in beddingImages.parallel"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
              ...
              <div v-show="!collapsed.erosion">
                ...
                <div class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in erosionImages.scour"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
                ...
                <div class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in erosionImages.tool"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
                ...
                <div class="subtype">
                  ...
                  <div class="image-gallery">
                    <div
                      class="gallery-item"
                      v-for="(item, index) in erosionImages.rill"
                      :key="index"
                    >
                      <img
                        :src="require(`@/assets/${item.image}`)"
            ...
            <div class="structure-type">
              ...
              <div v-show="!collapsed.deformation">
                ...
                <p>
                  常见的变形构造主要包括火焰状构造、包卷层理、干裂和雨痕等。
                </p>
                <div class="image-gallery">
                  <div
                    class="gallery-item"
                    v-for="(item, index) in deformationImages"
                    :key="index"
                  >
                    <img
                      :src="require(`@/assets/${item.image}`)"
          ...
          >
            ...
            <div class="structure-type">
              <h4 class="structure-title" @click="toggleCollapse('crystal')">
                <span class="toggle-icon">{{
                  collapsed.crystal ? "+" : "-"
                }}</span>
                晶体印痕
              </h4>
              <div v-show="!collapsed.crystal">
                <p>
                ...
                <div class="image-gallery">
                  <div
                    class="gallery-item"
                    v-for="(item, index) in chemicalImages.crystal"
                    :key="index"
                  >
                    <img
                      :src="require(`@/assets/${item.image}`)"
            ...
            <div class="structure-type">
              ...
              <div v-show="!collapsed.birdseye">
                ...
                <div class="image-gallery">
                  <div
                    class="gallery-item"
                    v-for="(item, index) in chemicalImages.birdseye"
                    :key="index"
                  >
                    <img
                      :src="require(`@/assets/${item.image}`)"
            ...
            <div class="structure-type">
              <h4 class="structure-title" @click="toggleCollapse('concretion')">
                <span class="toggle-icon">{{
                  collapsed.concretion ? "+" : "-"
                }}</span>
                结核
              </h4>
              <div v-show="!collapsed.concretion">
                <p>
                ...
                <div class="image-gallery">
                  <div
                    class="gallery-item"
                    v-for="(item, index) in chemicalImages.concretion"
                    :key="index"
                  >
                    <img
                      :src="require(`@/assets/${item.image}`)"
            ...
            <div class="structure-type">
              ...
              <div v-show="!collapsed.stylolite">
                ...
                <div class="image-gallery">
                  <div
                    class="gallery-item"
                    v-for="(item, index) in chemicalImages.stylolite"
                    :key="index"
                  >
                    <img
                      :src="require(`@/assets/${item.image}`)"
          ...
          >
            ...
            <div class="structure-type">
              ...
              <div v-show="!collapsed.stromatolite">
                ...
                <div class="image-gallery">
                  <div
                    class="gallery-item"
                    v-for="(item, index) in biologicalImages.stromatolite"
                    :key="index"
                  >
                    <img
                      :src="require(`@/assets/${item.image}`)"
            ...
            <div class="structure-type">
              ...
              <div v-show="!collapsed.tracefossil">
                ...
                <p>
                  遗迹化石的研究可以为古生物学、地层学、古生态和沉积环境提供许多有用的资料。
                </p>
                <div class="image-gallery">
                  <div
                    class="gallery-item"
                    v-for="(item, index) in biologicalImages.tracefossil"
                    :key="index"
                  >
                    <img
                      :src="require(`@/assets/${item.image}`)"

              ...
              <div v-show="!collapsed.ripple">
                ...
                <div v-show="activeRippleType === 'current'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <img
                      src="@/assets/current_ripple1.jpg"
                      alt="流水波痕示例"
                      @click="openLightbox('current_ripple1.jpg')"
                    />
                    <img
                      src="@/assets/current_ripple2.jpg"
                      alt="流水波痕剖面"
                ...
                <div v-show="activeRippleType === 'wave'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <img
                      src="@/assets/wave_ripple1.jpg"
                      alt="浪成波痕示例"
                      @click="openLightbox('wave_ripple1.jpg')"
                    />
                    <img
                      src="@/assets/wave_ripple2.jpg"
                      alt="浪成波痕剖面"
                ...
                <div v-show="activeRippleType === 'wind'" class="subtype">
                  ...
                  <div class="image-gallery">
                    <img
                      src="@/assets/wind_ripple1.jpg"
                      alt="风成波痕示例"
                      @click="openLightbox('wind_ripple1.jpg')"
                    />
                    <img
                      src="@/assets/wind_ripple2.jpg"
                      alt="风成波痕剖面"
                      @click="openLightbox('wind_ripple2.jpg')"
                    />
                  </div>
                </div>
              </div>

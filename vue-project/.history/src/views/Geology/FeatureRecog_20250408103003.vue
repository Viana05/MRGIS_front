      ...
      <div class="header">
        ...
        <div class="geo-image-group">
          <div class="geo-image-wrapper">
            <img src="@/assets/FeatureRecog/地层图1.jpg" class="geo-image" alt="地层图" />
            <div class="geo-image-caption">地层图</div>
          </div>
          <div class="geo-image-wrapper">
            <img src="@/assets/FeatureRecog/地层图2.jpg" class="geo-image" alt="地层图" />
            <div class="geo-image-caption">地层图</div>
          </div>
        </div>
        <div class="geo-image-wrapper">
          <img
            src="@/assets/FeatureRecog/地层图1.jpg"
            class="geo-image"
            alt="地层图"
          />
          <div class="geo-image-caption">地层图</div>
...
.geo-image-with-text .geo-image-wrapper {
  flex: 1;
  min-width: 300px;
}

.geo-image-with-text .geo-text-content {
  flex: 1;
}
...
/* 主题色扩展 */
.theme-marine .geo-image-caption {
  /* 海相主题 */
  background: #0288d1;
}

.theme-lake .geo-image-caption {
  /* 湖泊相主题 */
  background: #00796b;
}

.theme-fluvial .geo-image-caption {
  /* 河流相主题 */
  background: #5d4037;
}

.theme-desert .geo-image-caption {
  /* 沙漠相主题 */
  background: #f57c00;
}

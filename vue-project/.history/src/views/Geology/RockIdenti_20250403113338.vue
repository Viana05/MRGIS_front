              ...
              <div class="igneous-content">
                ...
                <div class="field-feature">
                  ...
                  <div class="rock-section">
                    <div class="rock-text">
                      <p><strong>手标本特征：</strong></p>
                      <ul>
                        <li>
                          纯橄榄岩：几乎全由橄榄石组成。橄榄石为浅绿色，粒状，玻璃光泽，没有解理。
                        </li>
                        <li>橄榄岩：主要由橄榄石组成，其次为辉石。</li>
                        <li>辉石岩：几乎全由辉石组成。</li>
                        <li>
                          蛇纹石化橄榄岩：网格状构造，有粒状橄榄石的残核。蛇纹石为橄榄岩蚀变产物。
                        </li>
                        <li>
                          苦橄岩：以橄榄石为主，可出现少量的角闪石、黑云母等。成分相当于橄榄岩。
                        </li>
                      </ul>
                    </div>
                    <div class="rock-image-group">
                      <div class="rock-image-container">
                        <img
                          ...
                          alt="纯橄榄岩"
                        />
                        <div class="content-image-caption">纯橄榄岩</div>
                      </div>
                      <div class="rock-image-container">
                        <img
                          ...
                          alt="辉石岩"
                        />
                        <div class="content-image-caption">辉石岩</div>
                      </div>
                    </div>
                  </div>
                  <div class="rock-section">
                    <div class="rock-text">
                      ...
                      <ul>
                        <li>纯橄榄岩：橄榄石呈自形粒状或他形粒状。</li>
                        <li>辉石岩：斜方辉石和单斜辉石均有。</li>
                        <li>
                    ...
                    <div class="rock-image-group">
                      <div class="rock-image-container">
                        <img
                          ...
                          alt="蛇纹石化橄榄岩"
                        />
                        <div class="content-image-caption">蛇纹石化橄榄岩</div>
                      </div>
                      <div class="rock-image-container">
                        <img
                          ...
                          alt="苦橄岩"
                        />
                        <div class="content-image-caption">苦橄岩</div>
                      </div>
                    </div>
                  </div>
                </div>

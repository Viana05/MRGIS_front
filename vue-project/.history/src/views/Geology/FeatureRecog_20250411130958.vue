                ...
                <div class="geo-image-group uniform-height">
                  <div class="geo-image-wrapper">
                    <img
                      ...
                      alt="意大利威尼斯泻湖"
                    />
                    <div class="geo-image-caption theme-desert">意大利威尼斯泻湖</div>
                  </div>
                  <div class="geo-image-wrapper">
                    <img
            ...
            <div class="facies-type">
              ...
              <div v-show="!isCollapsed.shelf">
                <div class="geo-image-group uniform-height">
                  ...
                  <div class="geo-image-wrapper">
                    <img
                      src="@/assets/FeatureRecog/06沉积相/古代浅海陆棚相.jpg"
                      class="geo-image"
                      alt="古代浅海陆棚相"
                    />
                    <div class="geo-image-caption theme-desert">古代浅海陆棚相</div>
                  </div>
                  <div class="geo-image-wrapper">
                    <img
                      src="@/assets/FeatureRecog/06沉积相/古代滨外陆棚.jpg"
                      class="geo-image"
                      alt="古代滨外陆棚"
                    />
                    <div class="geo-image-caption theme-desert">古代滨外陆棚</div>
                  </div>
                </div>
                <p>

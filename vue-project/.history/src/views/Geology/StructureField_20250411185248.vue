...
const images = ref([
  {
    src: "@/assets/StructureField/01断层/断层图片1.jpg",
    alt: "断层图片1",
    title: "断层",
    description: '深层次韧性剪切带中的糜棱岩'
  },
  {
    src: "@/assets/StructureField/01断层/断层图片2.jpg",
    alt: "断层图片2",
    title: "断层",
  },
  {
    src: "@/assets/StructureField/01断层/断层图片3.jpg",
    alt: "断层图片3",
    title: "断层",
  },
]);
        ...
        <section class="section">
          ...
          <div v-if="expandedSections.extensionTypes" class="section-content">
            ...
            <div class="definition-card" style="border-left-color: #8e44ad">
              <h3>伸展构造型式</h3>
              <p>
                在大陆伸展地区，伸展构造主要表现为正向滑动为主的断层、剪切带和拆离带组合型式，发育在不同的层次、尺度、区域构造背景和构造演化阶段。包括了以下几个构造型式：地堑和地垒、断陷盆地、裂谷、变质核杂岩、岩墙群。
              </p>
              <p>
                地堑（graben）是地壳上广泛发育的一种地质构造，为两侧被高角度断层围限，中间下降的槽形断块构造。
              </p>
              <p>
                仅在一侧为断层所限的断陷，称为半地堑或箕状构造。大规模地堑发育的地方，预示着地壳拉伸变薄
                。
              </p>
              <p>
                地堑常成长条形的断陷盆地，东非大裂谷、我国东部新生代盆地都是典型的地堑构造系。
              </p>
              <p>
                地垒（horst）与地堑恰好相反，由两组走向平行反向倾斜的正断层构成。在简单情况下，由两条正断层组成的地垒，中间共同的下盘上升，两侧的断层上盘下降。
              </p>
              <p>
                通常情况下，地堑和地垒相伴发育，正断层多呈阶梯状，形成盆岭构造（以美国盆岭区为原型命名的大型伸展构造）。
              </p>
              <p>
                盆岭构造是指在伸展变形区域，由掀斜构造、阶梯状正断层、地堑、地垒等共同产出，形成由不对称的纵列单面山、山岭及其间的盆地组合而成的构造一地貌单元。
              </p>
              <p>
                在伸展背景条件下受基底及盆缘正断层控制发育的沉积盆地，称为断陷盆地。如我国东部的华北盆地、松辽盆地和江汉盆地等。
              </p>
              <p>
                如果断陷盆地一侧断层发育，形成一侧由主干弧形或铲形正断层控制的不对称盆地，则称为箕状断陷或半地堑盆地。一般情况下，断陷盆地规模越大，盆缘及盆内构造越复杂。
              </p>
              <p>
                裂谷是区域性伸展隆起背景上形成的巨大窄长断陷，切割深，发育演化期长，常具有地堑型式。按照裂谷发育的区域构造部位及其地质构造特征，可分为以下三类：大洋裂谷、大陆裂谷、陆间裂谷。
              </p>
              <p>
                大西洋中央海岭上的裂谷是大洋裂谷的典型，东非裂谷是大陆裂谷的典型，红海裂谷是陆间裂谷的典型。
              </p>
              <p>
                裂谷在板块构造学中是大陆崩裂、大洋开启的初始阶段，是洋盆的雏形，但并非都会演化发展成为大洋。当裂谷中止伸展开裂，停止发育，裂谷坳陷就可能被各类岩石所充填而失去构造形态特征。
              </p>
              <p>
                变质核杂岩是由从深部抽拉抬升的强烈变质变形基底(下盘)和变质变形较弱的盖层（上盘）组成，外形近圆形或椭圆形，半径可达般万余米，呈分散孤立的穹隆状产出。
              </p>
              <p>
                基底与盖层以规模巨大的低角度正断拆离断层分隔。拆离断层原始产状近水平，在伸展拆离中变成犁式。其上盘以发育多米诺式断层为特征，亦有次级顺层断层，并使地层拆离减薄和缺失。
              </p>
              <p>
                岩墙是横切围岩构造的板状侵入岩体，常成群出现，呈平行或放射状排列，是一种伸展构造的重要样式。
              </p>
              <p>
        ...
        <section class="section">
          ...
          >
            ...
            <div class="definition-card" style="border-left-color: #9b59b6">
              ...
              <p>
                B. Wernicke和B. C.
                Burchfiel等人根据断层面几何形态及断块沿断层面位移特点，将正断层划分为两种类型，即非旋转(高角度)的和旋转的。
              </p>
              <p>
                其中旋转一类中又分出仅岩层旋转的铲状断层及断层和岩层均旋转的平面断层或铲状断层，并分别讨论了计算它们伸展量的方法。
              </p>
              <p>
                B.
                Wernicke等的正断层分类适合于地壳浅层次及伸展盆地内断层的观察和解释。当然，它们的组合型式也可能反映了深部更大规模的伸展构造。
              </p>
              <p>
                利斯特等(G. S. Lister,
                1986)依据形成断层组合应力状态，总结了大陆伸展构造的如下三种模式，而不同模式形成的伸展构造型式也有明显差异。三种模式分别为：纯剪模式、单剪模式、分层剪切或滑动剪切。
              </p>
              <p>
              ...
              <p>
                马杏垣(1982)参考G. P.
                Eaton对北美大盆地地壳剖面解释，提出一个伸展大陆壳结构模型，具有代表性。
              </p>
              <p>
                从图中可以看出，地壳浅层次以各种正断层及低缓角度拆离带组合为主，中层次以塑性变形为主，表现为塑性伸展流动，出现糜棱岩带和网结状韧性剪切带，地壳深部除塑性伸展流动变形外，尚发育大量基性岩墙(床)群。
              </p>
              <p>
                Vink等人早已指出，大陆壳发育裂谷作用要比在洋壳上容易得多，这是因为大陆岩石圈比大洋岩石圈强度小。大量的实践证明，大陆裂谷一般产生在古老的逆冲构造带，变质核杂岩大多发育于造山带，是造山期后伸展作用的结果。
              </p>
              <p>
                G.
                Ranalli认为，增厚的岩石圈拆沉作用是造山带构造演化的一个重要动力学过程，可以导致由挤压体制向伸展体制的反转。
              </p>
              <p>
                拆沉作用的基本涵义是：大陆岩石圈地幔由于较软流圈温度低、密度较大，从而产生重力不稳，如有合适的断裂，岩石圈地慢将沉陷入软流圈中，并使岩石圈减薄。
              </p>
              <p>
                理论计算证明，岩石圈根带的拆沉作用(delamination)，可产生水平方向的差异张应力50~100MPa，足以驱动大规模伸展构造的发育。
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="section">
          ...
          <div v-if="expandedSections.shearTypes" class="section-content">
            ...
            <div class="definition-card" style="border-left-color: #e74c3c">
              <h3>剪切带类型</h3>
              <p>
                根据剪切带的几何产状和运动方式，可将剪切带划分为走滑(平移)型剪切带、推覆(逆冲)型剪切带和滑覆(正断)型剪切带等主要类型。根据剪切带发育的物理环境和变形机制的不同,可将剪切带划分为下列三种基本类型：脆性剪切带、脆—韧（韧—脆）性剪切带、韧性剪切带。
              </p>
              <p>
                脆性剪切带是在地壳上部的低温及高孔隙压力与静岩压力比条件下发生的脆性变形的产物。
              </p>
              <p>
                其特点是具有一个或多个清楚的不连续界面，两盘位移明显，变形集中在个别不连续面上，伴生有各种碎裂岩系列的断层岩。
              </p>
              <p>
                脆-韧性剪切带有多种类型，主要型式有两种：一种为似断层牵引现象的脆-韧性剪切带。
              </p>
              <p>
                在韧性变形的岩石内部发育不连续面，沿不连续面可能产生摩擦滑动，其两侧一定范围内的岩层或其他标志体则发生一定程度的塑性变形；
              </p>
              <p>
                另一种为韧-脆性剪切带由张裂脉的雁行状阵列表现出来，雁列张裂隙反映岩石的跪性变形，而张裂隙之间的岩石一般受到一定程度的塑性变形。
              </p>
              <p>
                韧性剪切带是岩石在塑性状态下发生连续变形的狭窄高剪切应变带。典型韧性剪切带内变形状态从一壁穿过剪切带到另一壁是连续的，无破裂或不连续面。
              </p>
              <p>
                带内变形和两盘的位移完全由岩石的塑性流动或晶内变形来完成，并遵循不同的塑性或粘性蠕变律。
              </p>
              <p>
                根据剪切带的边界条件和位移情况，韧性剪切带的几何类型可分为如下两种：剪切带外的岩石未受变形的韧性剪切带、剪切带外的岩石受到均匀应变的韧性剪切带。
              </p>
              <p>
                剪切带外的岩石未受变形的韧性剪切带包括：不均匀的简单剪切（A）；不均匀的体积变化（B）；不均匀的简单剪切和不均匀的体积变化之联合（C）。
              </p>
              <p>
                剪切带外的岩石受到均匀应变的韧性剪切带包括：均匀应变与不均匀的简单剪切之联合（D）；均匀应变与不均匀的体积变化之联合（E）；均匀应变、不均匀的简单剪切和不均匀的体积变化之联合（F）。
              </p>
            </div>
          </div>
        </section>
...
/* 图片尺寸分级控制 */
.geo-image-small {
  max-width: 50%; /* 小图宽度不超过容器50% */
}

.geo-image-medium {
  max-width: 70%; /* 中图宽度不超过容器70% */
}

.geo-image-large {
  max-width: 85%; /* 大图宽度不超过容器85% */
}

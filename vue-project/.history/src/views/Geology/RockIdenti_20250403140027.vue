...
import rhyolitePorphyryImg from "@/assets/RockIdenti/流纹斑岩.jpg";
import quartzPorphyryImg from "@/assets/RockIdenti/石英斑岩.jpg";
...
const graniticRocks = [
  ...
  {
    name: "流纹斑岩",
    image: rhyolitePorphyryImg,
    macro: "具有长石和石英斑晶的流纹岩。斑晶含量＞30％。",
    micro: "斑晶主要为石英和碱性长石，基质为隐晶质。",
  },
  {
    name: "石英斑岩",
    image: quartzPorphyryImg,
    macro: "以石英为斑晶的流纹岩。但也有浅成的石英斑岩。",
    micro: "石英斑晶特征明显，基质为隐晶质或微晶结构。",
  },
  {
    name: "流纹英安岩",
    image: rhyodaciteImg,

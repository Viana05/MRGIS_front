          ...
          <div v-if="activeSection === 'purpose'" class="purpose-section">
            <div class="geology-card">
              ...
              <div class="card-content">
                <p>地质罗盘仪是进行野外地质工作必不可少的一种工具。借助它可以定出方向，观察点的所在位置，测出任何一个观察面的空间位置（如岩层层面、褶皱轴面、断层面、节理面...等构造面的空间位置），以及测定火成岩的各种构造要素，矿体的产状等。因此必须学会使用地质罗盘仪。</p>
          ...
          <div v-if="activeSection === 'structure'" class="structure-section">
            <div class="geology-card">
              ...
              <div class="structure-grid">
                <div class="structure-item" v-for="(item, index) in [
                  { title: '磁针', icon: 'icon-magnet', content: '一般为中间宽两边尖的菱形钢针，安装在底盘中央的顶针上，可自由转动，不用时应旋紧制动螺丝，将磁针抬起压在盖玻璃上避免磁针帽与项针尖的碰撞，以保护顶针尖，延长罗盘使用时间。在进行测量时放松固动螺丝，使磁针自由摆动，最后静止时磁针的指向就是磁针子午线方向。由于我国位于北半球磁针两端所受磁力不等，使磁针失去平衡。为了使磁针保持平衡常在磁针南端绕上几圈铜丝，用此也便于区分磁针的南北两端。' },
                  { title: '水平刻度盘', icon: 'icon-dial', content: '水平刻度盘的刻度是采用这样的标示方式:从0度开始按逆时针方向每10度一记，连续刻至360度，0度和180度分别为N和S，90度和270度分别为E和W，利用它可以直接测得地面两点间直线的磁方位角。' },
                  { title: '竖直刻度盘', icon: 'icon-vertical', content: '专用来读倾角和坡角读数，以E或W位置为0度，以S或N为90度，每隔10度标记相应数字。' },
                  { title: '悬锥', icon: 'icon-pendulum', content: '是测斜器的重要组成部分，悬挂在磁针的轴下方，通过底盘处的视板手可使悬锥转动，悬锥中央的尖端所指刻度即为倾角或坡角的度数。' },
                  { title: '水准器', icon: 'icon-level', content: '通常有两个，分别装在圆形玻璃管中，圆形水准器固定在底盘上，长形水准器固定在测斜仪上。' },
                  { title: '瞄准器', icon: 'icon-sight', content: '包括接物和接目觇板，反光镜中间有细线，下部有透明小孔，使眼睛，细线，目的物三者成一线，作瞄准之用。' }
                ]" :key="index">
            ...
            <div class="geology-card">
              ...
              <div class="method-item">
                ...
                <div class="method-content">
                  <p>测定目的物与测者间的相对位置关系，也就是测定目的物的方位角(方位角是指从子午线[经线]顺时针方向到该测线的夹角)。</p>
                  <p>测量时放松制动螺丝，使对物觇板指向测物，即使罗盘北端对着目的物，南端靠着自己，进行瞄准，使目的物，对物觇板小孔，盖玻璃上的细丝，对目觇板小孔等连在一直线上，同时使底盘水准器水泡居中，待磁针静止时指北针所指度数即为所测目的物之方位角。(若指针一时静止不了，可读磁针摆动时最小度数的二分之一处，测量其它要素读数时亦同样)。</p>
                ...
                <div class="method-content">
                  <div class="strata-types">
                    <div class="strata-def">
                      <h4>岩层走向</h4>
                      <p>（实质是山脉延伸方向）是岩层层面与水平面交线的延伸方向。</p>
                    </div>
                    <div class="strata-def">
                      <h4>岩层倾向</h4>
                      <p>（实质是山体倾斜方向）是岩层面上的倾斜线在水平面的投影所指方向。</p>
                    </div>
                    <div class="strata-def">
                      <h4>倾角</h4>
                      <p>是岩层层面与水平面所夹的锐角（真倾角是倾斜岩体的重心方向与水平面夹角)）</p>
                    </div>
                  </div>
                  ...
                  <div class="measure-steps">
                    <div class="step">
                      ...
                      <div class="step-content">
                        <h4>测量走向</h4>
                        <p>使罗盘的长边(即南北边)紧贴层面，将罗盘放平，水准泡居中，读指北针所示的方位角，就是岩层的走向。</p>
                      </div>
                    </div>
                    <div class="step">
                      ...
                      <div class="step-content">
                        <h4>测量倾向</h4>
                        <p>将罗盘的短边紧贴层面，水准泡居中，读指北针所示的方位角，就是岩层的倾向。</p>
                      </div>
                    </div>
                    <div class="step">
                      ...
                      <div class="step-content">
                        <h4>测量倾角</h4>
                        <p>需将罗盘横着竖起来，使长边与岩层的走向垂直，紧贴层面，待倾斜器上的水准泡居中后，读悬锤所示的角度，即为倾角。</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="notes-box">
                    ...
                    <ul>
                      <li><strong>A. 测方向时</strong>读圆刻度盘，盘面要保持水平(圆水准居中)。走向是用长边贴岩层面；倾向是用短边贴岩层面。</li>
                      <li><strong>B. 测角度时</strong>读半圆刻度盘，盘面垂直岩层面(管水准居中)。要注意测真倾角(最大角)。</li>
                      <li><strong>C. 走向与倾向关系</strong>走向为倾向加/减90°。所以野外只需测倾向与倾角。</li>
                    </ul>
...
.icon-dial:before { content: "⏱️"; }
.icon-vertical:before { content: "📐"; }
.icon-pendulum:before { content: "⏳"; }
.icon-level:before { content: "⚖️"; }
.icon-sight:before { content: "🎯"; }
.icon-azimuth:before { content: "🧭"; }
.icon-strata:before { content: "🏔️"; }

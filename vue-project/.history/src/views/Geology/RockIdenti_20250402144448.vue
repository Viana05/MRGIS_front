            ...
            >
              <div class="rock-content">
                ...
                <p class="highlight-info">
                  <strong>闪长岩</strong>为典型的中性岩，整体呈暗灰色。其中主要成分为白色的斜长石和深色的角闪石，还含有少量的辉石、黑云母和石英等。
                </p>
                <p class="highlight-info">
                  <strong>辉长岩</strong>为来源于深部地壳或上地幔的玄武质岩浆经侵入作用形成，主要矿物成分为基性斜长石和单斜辉石，广泛分布于地壳的各种构造环境和月球上。
                </p>
                <p class="highlight-info">
                  <strong>伟晶岩</strong>是由巨粒矿物组成的淡色结晶岩，是富含挥发分的硅酸盐残浆，侵入到火成岩或围岩裂隙中缓慢结晶而成的。
                </p>

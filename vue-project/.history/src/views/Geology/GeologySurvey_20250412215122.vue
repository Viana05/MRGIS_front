...
const props = defineProps({
  slides: {
    ...
    default: () => [
      {
        image: "/images/geo-slide1.jpg",
        alt: "地质勘探现场",
        title: "野外地质调查",
        description: "专业地质罗盘使用示范",
      },
      {
        image: "/images/geo-slide2.jpg",
        alt: "岩层分析",
        title: "岩层产状测量",
        description: "精确测量走向、倾向和倾角",
      },
      {
        image: "/images/geo-slide3.jpg",
        alt: "矿物标本",
        title: "矿物标本采集",
        description: "野外矿物标本采集与记录",
      },
    ],
  },
  interval: {

      ...
      <div v-if="activeTab === '乔木观测'">
        ...
        <div class="field-grid">
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>字段类型：</strong>C</p>
            <p class="field-item"><strong>注释：</strong>推荐以《中国植物志》为标准填写</p>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>定义：</strong>使用双名法命名的物种的完整名称，包含命名人</p>
            <p class="field-item"><strong>字段类型：</strong>C</p>
            <p class="field-item"><strong>注释：</strong>推荐以《中国植物志》为标准填写</p>
            <p class="field-item"><strong>字段示例：</strong>Gironniera subaequalis Planch.</p>
          </div>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>英文名称：</strong>Diameter at Breast Height</p>
          ...
          <div class="field-card">
            <h3>（8）枝下高</h3>
            <p class极速赛车开奖结果查询class="field-item"><strong>标识：</strong>clearboleHeight</p>
            <p class="field-item"><strong>中文名称：</strong>枝下高</p>
            <p class="field-item"><strong>英文名称：</strong>Clear Bole height</p>
            <p class="field-item"><strong>定义：</strong>调查植株的树干上第一个一级分枝以下的高度</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>米（m）</p>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>定义：</strong>对字段中未包含的内容进行的补充说明</p>
            <p class="field-item"><strong>字段类型：</strong>C</p>
      ...
      <div v-if="activeTab === '灌木观测'">
        ...
        <div class="field-grid">
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>中文名称：</strong>样方长</p>
            <p class="field-item"><strong>英文名称：</strong>Quadrat Length</p>
            <p class="极速赛车开奖结果查询field-item"><strong>定义：</strong>植被调查样方的长度</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>米（m）</p>
            <p class="field-item"><strong>字段示例：</strong>5</p>
          </div>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>英文名称：</strong>Scientific Name</p>
            <p class="field-item"><strong>定义：</strong>使用双名法命名的物种的完整名称，包含命名人</p>
            <p class="field-item"><strong>字段类型：</strong>极速赛车开奖结果查询C</p>
            <p class="field-item"><strong>注释：</strong>推荐以《中国植物志》为标准填写</p>
            <p class="field-item"><strong>字段示例：</strong>Rhododendron lapponicum (L.) Wahl.</p>
          </div>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>定义：</strong>植株中最高植株的高度</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>米（m）</p>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>定义：</strong>调查样方中植株的平均高度</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>米（m）</p>
            <p class="field-item"><strong>字段示例：</strong>1.5</p>
          </div>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>英文名称：</strong>Maximum Base Diameter</p>
            <p class="field-item"><strong>定义：</strong>调查样方中植株的最大基径</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>厘米（cm）</p>
            <p class="field-item"><strong>注释：</strong>基径测量基准点为树木地面根颈部位的树干直径</p>
            <p class="field-item"><strong>字段示例：</strong>5.1</p>
          </div>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>英文名称：</strong>Average Base Diameter</p>
            <p class="field-item"><strong>定义：</strong>调查样方中植株的平均基径</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>厘米（cm）</p>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>定义：</strong>样方中灌木植物的总株数或总丛数</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>定义：</strong>该植物地上部分的垂直投影面积占样方面积的百分比</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>%</p>
            <p class="field-item"><strong>注释：</strong>填写百分比数值，如"12.3%"，以"12.3"填写</p>
      ...
      <div v-if="activeTab === '草本植物观测'">
        ...
        <div class="field-grid">
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>定义：</strong>使用双名法命名的物种的完整名称，包含命名人</p>
            <p class="field-item"><strong>字段类型：</strong>C</p>
            <p class="field-item"><strong>注释：</strong>推荐以《中国植物为标准填写</p>
            <p class="field-item"><strong>字段示例：</strong>Stipa sareptana A.K. Becker var. krylovii (Roshev.) P.C. Kuo & Y.H. Sun</p>
          </div>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>中文名称：</strong>株丛数</p>
            <p class="field-item"><strong>英文名称：</strong>Stem Count</p>
            <p class="field-item"><strong>定义：</strong>样方中草本植物的总株数或总丛数</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>株或丛／样方</p>
            <p class="field-item"><strong>注释：</strong>整数型数据</p>
          ...
          <div class="field-card">
            ...
            <p class="field-item"><strong>中文名称：</strong>盖度</p>
            <p class="field-item"><strong>英文名称：</strong>Coverage</p>
            <p class="field-item"><strong>定义：</strong>植物地上部分的垂直投影面积占样方面积的百分比</p>
            <p class="field-item"><strong>字段类型：</strong>N</p>
            <p class="field-item"><strong>字段单位：</strong>%</p>
            <p class="field-item"><strong>注释：</strong>填写百分比数值，如"21.0%"，以"21.0"填写</p>

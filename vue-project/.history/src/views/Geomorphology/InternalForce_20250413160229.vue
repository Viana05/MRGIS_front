...
const getImagePath = (title) => {
  // 实际项目中应根据title返回对应的图片路径
  switch(title) {
    case '褶皱要素示意图': return '@/assets/InternalForce/01褶皱地貌/褶皱要素.jpg'
    case '直立褶皱': return '@/assets/InternalForce/01褶皱地貌/直立褶皱.jpg'
    case '斜歪褶皱': return '@/assets/InternalForce/01褶皱地貌/斜歪褶皱.jpg'
    case '倒转褶皱': return '@/assets/InternalForce/01褶皱地貌/倒转褶皱.jpg'
    case '平卧褶皱': return '@/assets/InternalForce/01褶皱地貌/平卧褶皱.jpg'
    case '翻卷褶皱': return '@/assets/InternalForce/01褶皱地貌/翻卷褶皱.jpg'
    default: return ''
  }
}
...
<template>
  <div class="geology-container">
    ...
    <div class="fold-features">
      <h3>褶皱要素</h3>
      <p>褶皱要素是褶皱的基本组成部分，主要包括核、翼、转折端、枢纽、轴面、拐点以及脊线和槽线。</p>
      
      <div class="image-gallery">
        <div class="image-with-caption">
          <img 
            src="@/assets/InternalForce/01褶皱地貌/褶皱要素.jpg" 
            alt="褶皱要素示意图"
            class="geology-image"
            @click="showFullscreen('褶皱要素示意图')"
          >
          <p class="image-caption">图1：褶皱要素示意图</p>
        </div>
      </div>

      <div class="term-definition">
        <p><strong>核（core）</strong>是褶皱的中心部分，<strong>翼（limb）</strong>为褶皱中心两侧平弧状的部分。相邻背形和向形共用翼的褶皱面上凸与下凹部分的分界点（翼部曲率为零）被称为<strong>拐点</strong>。</p>
        
        <p><strong>翼间角</strong>是指正交剖面上两翼间的内夹角，而单一褶皱面上最大弯曲点的连线为<strong>枢纽</strong>。褶皱面从一翼过渡到另一翼的弯曲部分被称为<strong>转折端（hinge zone）</strong>。</p>
        
        <p>同一背形褶皱面的最高点的连线称为<strong>脊线</strong>；反之，同一向形褶皱面的最低点的连线称为<strong>槽线</strong>。各相邻褶皱面的枢纽连成的面称为<strong>轴面（axial plane）</strong>，轴面与地面或其他任何面的交线称<strong>轴迹</strong>。</p>
      </div>
      ...
      <div class="classification-section">
        <div class="classification-item">
          <h5>按转折端形态：</h5>
          <p>褶皱转折端的形态有圆弧状、尖棱状、箱状等，据此褶皱可被描述为以下几种：<strong>挠曲</strong>、<strong>尖棱褶皱</strong>、<strong>圆弧褶皱</strong>、<strong>箱状褶皱</strong>。</p>
        </div>

        <div class="classification-item">
          <h5>按翼间角大小：</h5>
          <p>根据翼间角的大小，可将褶皱描述为<strong>平缓褶皱</strong>、<strong>开阔褶皱</strong>、<strong>中常褶皱</strong>、<strong>紧闭褶皱</strong>和<strong>等斜褶皱</strong>。</p>
        </div>

        <div class="classification-item">
          <h5>按轴面产状：</h5>
          <p>根据轴面产状和两翼产状，褶皱可被分为<strong>直立褶皱</strong>、<strong>斜歪褶皱</strong>、<strong>褶皱</strong>、<strong>平卧褶皱</strong>和<strong>翻卷褶皱</strong>。</p>
        </div>
      </div>

      <div class="fold-types-gallery">
        <h5>轴面和两翼产状不同的褶皱图示</h5>
        <div class="image-group">
          <div class="image-with-caption">
            <img 
              src="@/assets/InternalForce/01褶皱地貌/直立褶皱.jpg" 
              alt="直立褶皱"
              class="geology-image"
              @click="showFullscreen('直立褶皱')"
            >
            <p class="image-caption">A.直立褶皱</p>
          </div>
          <div class="image-with-caption">
            <img 
              src="@/assets/InternalForce/01褶皱地貌/斜歪褶皱.jpg" 
              alt="斜歪褶皱"
              class="geology-image"
              @click="showFullscreen('斜歪褶皱')"
            >
            <p class="image-caption">B.斜歪褶皱</p>
          </div>
          <div class="image-with-caption">
            <img 
              src="@/assets/InternalForce/01褶皱地貌/倒转褶皱.jpg" 
              alt="倒转褶皱"
              class="geology-image"
              @click="showFullscreen('倒转褶皱')"
            >
            <p class="image-caption">C.倒转褶皱</p>
          </div>
          <div class="image-with-caption">
            <img 
              src="@/assets/InternalForce/01褶皱地貌/平卧褶皱.jpg" 
              alt="平卧褶皱"
              class="geology-image"
              @click="showFullscreen('平卧褶皱')"
            >
            <p class="image-caption">D.平卧褶皱</p>
          </div>
          <div class="image-with-caption">
            <img 
              src="@/assets/InternalForce/01褶皱地貌/翻卷褶皱.jpg" 
              alt="翻卷褶皱"
              class="geology-image"
              @click="showFullscreen卷褶皱')"
            >
            <p class="image-caption">E.翻卷褶皱; P.轴面(或正交剖面上的轴迹)</p>
          </div>
        </div>
      </div>
      ...
      <div class="symmetry-section">
        <h5>褶皱对称性</h5>
        <p>褶皱根据其对称性可分为<strong>对称褶皱</strong>和<strong>不对称褶皱</strong>。对称褶皱的轴面与褶皱包络面垂直，且两翼长度基本相等。不对称褶皱的轴面与褶皱的包络面斜交，且两翼长度不等。</p>
      </div>

      <div class="plane-morphology">
        <h5>褶皱平面出露形态</h5>
        <p>褶皱的平面出露形态可根据褶皱中的同一褶皱面在平面上出露的纵向长度和横向宽度之比来描述。</p>
        
        <div class="morphology-types">
          <div class="morphology-item">
            <p><strong>等轴褶皱</strong>：长与宽之比近于1:1的褶皱为等轴褶皱，等轴背斜又称<strong>穹隆构造（dome）</strong>，等轴向斜又称<strong>构造盆地（basin）</strong>。</p>
          </div>
          <div class="morphology-item">
            <p><strong>短轴褶皱</strong>：长与宽之比约3:1～10:1的枢纽向两端倾伏的褶皱为短轴褶皱。</p>
          </div>
          <div class="morphology-item">
            <p><strong>线状褶皱</strong>：长与宽之比大于10:1的各类狭长褶皱被称为线状褶皱。</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- 全屏图片查看模态框 -->
    <div class="modal-if="showModal" @click.self="closeModal">
...
.image-gallery, .fold-types-gallery {
  margin: 25px 0;
}
...
.symmetry-section, .plane-morphology {
  background-color: white;
  padding: 15px;
  margin: 20px 0;
  border-radius: 5px;

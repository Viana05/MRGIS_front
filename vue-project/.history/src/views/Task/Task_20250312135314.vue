  ...
  <el-card class="page-container">
    ...
    >
      ...
      <el-form :model="taskModel" label-width="100px">
        ...
        <el-form-item>
          <el-button type="primary" @click="addTask();clearTaskData();">添加</el-button>
        </el-form-item>
      </el-form>
    </el-drawer>

    <!-- 添加任务弹窗 -->
    <el-dialog v-model="dialogVisible" title="添加任务" width="40%">
      <el-form
        :model="taskModel"
        :rules="rules"
        label-width="100px"
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="clearTaskData"> 确认 </el-button>
        </span>
      </template>
    </el-dialog>
  </el-card>

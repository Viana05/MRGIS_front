  ...
  <el-card class="page-container">
    <template #header>
      <div class="header">
        <span>任务管理</span>
        <div class="extra">
          <el-button type="primary" @click="visibleDrawer = true" v-if="userInfoStore.info.identity === '老师'"
            >添加任务</el-button
          >
        </div>
      </div>
    ...
    <el-table :data="tasks" style="width: 100%">
      <el-table-column
        ...
        prop="taskName"
      ></el-table-column>
      <el-table-column label="任务内容" width="200" prop="taskContent">
      </el-table-column>
      <el-table-column label="任务位置" prop="taskLocation"></el-table-column>
      <el-table-column label="时间" prop="updateTime"> </el-table-column>
      <el-table-column label="操作" width="100" v-if="userInfoStore.info.identity === '老师'">

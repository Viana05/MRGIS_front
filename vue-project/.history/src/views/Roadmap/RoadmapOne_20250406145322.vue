  ...
  <div class="cesium_map">
    ...
    <div class="floating-menu">
      <div class="menu-content">
        <el-row class="menu-row title-row">
          <span class="route-title">路线一: 徐州大北望</span>
          <el-tag type="primary" size="small">实习路线</el-tag>
        </el-row>

        <el-divider class="menu-divider"></el-divider>

        <el-row class="menu-row">
          <span class="section-label">粒子效果：</span>
          <el-checkbox-group
            v-model="weatherChecks"
            size="mini"
            class="compact-checks"
          >
            <el-checkbox-button
              label="下雪"
        ...
        <el-row class="menu-row">
          <span class="section-label">路线观察点：</span>
        ...
        <el-row class="menu-row">
          <span class="section-label">路线：</span>
          <el-button-group size="mini">
            <el-button
              type="primary"
              plain
        ...
        <el-row class="menu-row">
          <span class="section-label">量测：</span>
          <el-button-group size="mini" class="measure-btns">
            <el-tooltip content="空间距离" placement="top">
              <el-button
                type="primary"
                plain
                icon="el-icon-rank"
            ...
            <el-tooltip content="空间面积" placement="top">
              <el-button
                type="primary"
                plain
                icon="el-icon-crop"
            ...
            <el-tooltip content="三角量测" placement="top">
              <el-button
                type="primary"
                plain
                icon="el-icon-place"
            ...
            <el-tooltip content="清除量测" placement="top">
              <el-button
                type="danger"
                plain
                icon="el-icon-delete"
...
.compact-checks >>> .el-checkbox-button {
  margin-right: 0;
}

.compact-checks >>> .el-checkbox-button__inner {
  padding: 5px 8px;
  font-size: 12px;
}

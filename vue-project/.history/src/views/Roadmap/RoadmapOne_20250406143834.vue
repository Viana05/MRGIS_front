  ...
  <div class="cesium_map">
    ...
    <div class="floating-menu">
      <div class="menu-content">
        <el-row class="menu-row">
          <h3 class="route-title">路线一: 徐州大北望</h3>
          <el-button type="primary" icon="el-icon-info" @click="showIntrodution"
            >详情</el-button
          >
        </el-row>
        ...
        <el-row class="menu-row">
          <span class="section-title">天气特效：</span>
          <el-checkbox-group v-model="weatherEffects">
            <el-checkbox-button
              label="下雪"
        ...
        <el-row class="menu-row">
          <span class="section-title">路线观察点：</span>
          <el-button-group>
            <el-button
              type="success"
              icon="el-icon-view"
              @click="loadGeoJSONPoints"
              >显示</el-button
            >
            <el-button type="danger" icon="el-icon-delete" @click="clearPoints"
              >清除</el-button
            >
          </el-button-group>
        </el-row>
        ...
        <el-row class="menu-row">
          <span class="section-title">路线显示：</span>
          <el-button-group>
            <el-button
              type="success"
              icon="el-icon-map-location"
              @click="showPracticeRoute"
              >显示</el-button
            >
            <el-button
              type="danger"
              icon="el-icon-circle-close"
              @click="removePracticeRoute"
              >清除</el-button
            >
          </el-button-group>
        </el-row>
        ...
        <el-row class="menu-row">
          <span class="section-title">量测工具：</span>
          <el-button-group>
            <el-tooltip content="空间距离测量" placement="top">
              <el-button
                type="info"
            ...
            <el-tooltip content="空间面积测量" placement="top">
              <el-button
                type="info"
                icon="el-icon-crop"
                @click="onAreaMeasure"
            ...
            <el-tooltip content="三角测量" placement="top">
              <el-button
                type="info"
                icon="el-icon-place"
                @click="onTrianglesMeasure"
              ></el-button>
            </el-tooltip>
            <el-tooltip content="清除测量" placement="top">
              <el-button
                type="danger"
                icon="el-icon-delete"
                @click="onClear"
    ...
    <div class="detail-panel" :class="{ active: showDetail }">
      <div class="panel-header">
        <h3>徐州大北望路线详情</h3>
        <el-button icon="el-icon-close" circle @click="closeDetail"></el-button>
      </div>
      <div class="panel-content">
        <el-scrollbar>
          <div class="detail-content">
            <h4>路线简介</h4>
            <p>
              徐州大北望路线是自然地理与地质地貌实习的重要路线之一，全长约8公里，沿途可观察多种典型地质构造和地貌形态。
            </p>

            <h4>主要观察点</h4>
            <el-collapse>
              <el-collapse-item title="1. 大北望断层" name="1">
                <div>
                  典型的正断层构造，断距约15米，断面清晰可见，是研究断层活动的理想场所。
                </div>
              </el-collapse-item>
              <el-collapse-item title="2. 古生代灰岩露头" name="2">
                <div>
                  出露良好的古生代灰岩地层，含有丰富的化石，是研究古生物和地层学的良好材料。
                </div>
              </el-collapse-item>
              <el-collapse-item title="3. 河流阶地" name="3">
                <div>
                  发育完好的三级河流阶地，反映了区域新构造运动的阶段性特征。
                </div>
              </el-collapse-item>
              <el-collapse-item title="4. 风化壳剖面" name="4">
                <div>
                  典型的红色风化壳剖面，厚度达10米，是研究风化作用和古气候的重要证据。
                </div>
              </el-collapse-item>
            </el-collapse>
            ...
            <div class="route-map">
              <!-- <img
                src="@/assets/images/xuzhou-route.png"
                alt="徐州大北望路线图"
              />
            </div> -->
          </div>

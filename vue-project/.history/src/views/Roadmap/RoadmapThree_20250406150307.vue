...
const selectedLocation = ref("窑湾"); // 选择地点
...
const handleLocationChange = (location) => {
  // 清除当前显示的路线和观察点
  this.clearPoints();
  this.removePracticeRoute();

  // 可以根据选择的地点做一些初始化操作
  console.log("已切换到:", location);
};
    ...
    <div class="floating-menu">
      <div class="menu-content">
        <el-row class="menu-row">
          <strong>路线三 徐州窑湾及马陵山 </strong></el-row
        >
        <el-row class="menu-row">
          粒子效果：
          <el-checkbox
        ...
        <el-row class="menu-row">
          ...
          >
            <el-radio-button label="窑湾">窑湾</el-radio-button>
            <el-radio-button label="马陵山">马陵山</el-radio-button>
          </el-radio-group>
        </el-row>
        <el-row class="menu-row">
          路线观察点：
          <el-button
            type="primary"
            plain
            @click="loadGeoJSONPoints(selectedLocation)"
            >显示</el-button
          >
        ...
        <el-row class="menu-row">
          路线：
          <button onclick="showPracticeRoute(selectedLocation)">显示</button>

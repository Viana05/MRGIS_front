...
onMounted(() => {
  ...
  window.showPracticeRoute = function () {
    ...
    const positions_1 = routeCoordinates_1.map((coord) =>
      Cesium.Cartesian3.fromDegrees(coord[0], coord[1])
    );
    ...
    practiceRouteEntity_1 = viewer.entities.add({
      name: "实习路线",
      polyline: {
    ...
    const startPoint_1 = routeCoordinates_1[0];
    const endPoint_1 = routeCoordinates_1[routeCoordinates_1.length - 1];
    ...
    viewer.entities.add({
      name: "起点",
      position: Cesium.Cartesian3.fromDegrees(startPoint_1[0], startPoint_1[1]),
      point: {
        pixelSize: 15,
        color: Cesium.Color.GREEN,
        outlineColor: Cesium.Color.WHITE,
    ...
    viewer.entities.add({
      name: "终点",
      position: Cesium.Cartesian3.fromDegrees(endPoint_1[0], endPoint_1[1]),
      point: {
        pixelSize: 15,
        color: Cesium.Color.RED,
        outlineColor: Cesium.Color.WHITE,
  ...
  window.removePracticeRoute = function () {
    ...
    if (practiceRouteEntity_1) {
      viewer.entities.remove(practiceRouteEntity_1);
      practiceRouteEntity_1 = null;
    }

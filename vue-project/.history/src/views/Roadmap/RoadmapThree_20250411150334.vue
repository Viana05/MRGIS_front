  ...
  <div class="cesium_map">
    ...
    <div class="floating-menu">
      <div class="menu-content">
        <el-row class="menu-row"> <strong>路线三 徐州窑湾及马陵山</strong> </el-row>
        ...
        <el-row class="menu-row">
          ...
          <el-button type="primary" plain @click="loadGeoJSONPoints1"
            >显示窑湾</el-button
          >
          <el-button type="primary" plain @click="clearPoints1">清除窑湾</el-button>
        </el-row>
        <el-row class="menu-row">
          路线：
          <button onclick="showPracticeRoute1()">显示窑湾</button>
          <button onclick="removePracticeRoute()">清除窑湾</button>
        </el-row>
        <el-row class="menu-row">
          量测：

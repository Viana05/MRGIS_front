...
<template>
  <div class="cesium_map">
    ...
    <!-- 浮动菜单 -->
    <div class="cesium-style-menu">
      <div class="cesium-menu-header">
        <h3>地图控制面板</h3>
      </div>
      <div class="cesium-menu-content">
        <div class="cesium-menu-section">
          <h4>粒子效果</h4>
          <div class="cesium-menu-controls">
            <el-checkbox-group v-model="weatherEffects">
              <el-checkbox 
                label="snow" 
                @change="handleSnowChange"
                class="cesium-checkbox"
              >
                <span class="cesium-checkbox-label">下雪</span>
              </el-checkbox>
              <el-checkbox 
                label="rain" 
                ...
                class="cesium-checkbox"
              >
                <span class="cesium-checkbox-label">下雨</span>
              </el-checkbox>
              <el-checkbox 
                label="fog" 
                ...
                class="cesium-checkbox"
              >
                <span class="cesium-checkbox-label">大雾</span>
              </el-checkbox>
            </el-checkbox-group>
          </div>
        </div>
